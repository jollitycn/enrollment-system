...
//查询基本信息的负责人列表
export const queryChargerBySemesterId = (semesterId) => {
  return request({
    url: `/plan/queryChargerBySemesterId`,
    method: 'put',
    params: semesterId
  })
}
...
//查看招生专业信息明细
export const queryMajorInfoByMajorId = (query) => {
  return request({
    url: `/major/queryMajorInfoByMajorId`,
    method: 'get',
    params: query
  })
}
...
//根据院系id获取专业列表
export const majorlist = (departId) => {
  return request({
    url: `/major/queryMajorInfoByAPI`,
    method: 'get',
    params: departId
  })
}
