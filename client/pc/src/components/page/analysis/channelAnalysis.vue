  ...
  <div class="page-container">
    <div class="crumbs">
      <el-breadcrumb separator=">">
        ...
        <el-breadcrumb-item>渠道表</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div style="margin-top: 50px;">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-button @click="channelReport" type="primary">查询</el-button>
      </el-form>
...
<script>
  import { channelReport } from "@/api/admin/Dashboard/Dashboard"
  ...
  export default {
    ...
    methods: {
      ...
      channelReport() {
        this.loading = true
        channelReport(this.formInline).then(res => {
          console.log(res);
          this.tableData = res.data.channelReportVOS
          this.loading = false
        }).catch(err => {
          console.error(err);
          this.loading = false
