...
//    }
    ...
    public static <T> List<T> parseArrayAllField(String key,  Class<T> clazz) {
...
//    }
    ...
    private static void main(String[] args) {
        ...
        System.out.println(JSONRedisUtil.get("11", String.class));
        System.out.println(JSONRedisUtil.hGet("11","22", String.class));
    }
