...
import com.educiot.recruit.common.api.TermInfoResult;
...
public class TargetController extends BaseController {
    ...
    public Result list(ListTargetPageQuery param) {
        ...
        //分页获取招生目标列表
        IPage<TargetVO> page = targetService.getTargetListPage(param, loginUser);
    ...
    public Result addOrEdit(@Valid AddOrEditTargetReq addOrEditTargerReq) throws Exception {
        ...
        LoginUser loginUser = getLoginUser();
        //添加或编辑招生目标
        Long result = targetService.addOrEditTarget(addOrEditTargerReq, loginUser, getAPIRequest());
