package com.educiot.recruit.server.controller.api;
...
public class APIController extends BaseController {
    ...
    public Result addTerm(@RequestBody TermInfo termInfo) throws MyExcption {
        return Result.success(getAPIRequest().addTerm(termInfo));
    }
