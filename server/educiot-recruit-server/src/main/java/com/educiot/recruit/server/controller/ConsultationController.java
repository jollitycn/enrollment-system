...
//            wrapper.eq("semester_id", getLoginUser().getCurrentSemesterId());
    ...
    public Result<?> addOrEditConsultation(@RequestBody AddConsultationQuery addConsultationQuery) throws MyExcption {
        ...
        return consultationService.addOrEditConsultation(loginUser.getCurrentSemesterId(),loginUser.getSemesterName(),loginUser.getApiInfo().getUserId(),loginUser.getApiInfo().getUserName(), addConsultationQuery);
    }
    ...
    public Result<?> addConsultationDay(@RequestBody AddConsultationDayQuery addConsultationDayQuery) {
        ...
        return opendayService.addOrEditConsultationDay(loginUser.getApiInfo().getUserId(),loginUser.getApiInfo().getUserName(), addConsultationDayQuery);
    ...
    public Result<?> addConsultationFeedback(@RequestBody AddConsultationFeedbackQuery addConsultationFeedbackQuery) {
        ...
        boolean status = consultationFeedbackService.addConsultationFeedback(addConsultationFeedbackQuery, loginUser.getApiInfo().getUserId(),loginUser.getApiInfo().getUserName());
