...
import com.educiot.recruit.data.entity.vo.MessageTypeListVO;
...
public class NewsController extends BaseController {
    ...
    public Result addOrEdit(@RequestBody AddOrEditNewsReq addOrEditNewsReq) {
        ...
        //添加或编辑新闻
        Boolean result =newsService.addOrEditNews(addOrEditNewsReq,loginUser);
    ...
    public Result<?> getMessageTypeList() {
        ...
        List<SysDictionary> messageTypeListVOList = sysDictionaryService.getDictListByCode(loginUser, "news_message_type");
