...
public class MajorController extends BaseController {
    ...
    public Result addMajorInfo(@Valid @RequestBody AddMajorInfoQuery addMajorInfoQuery){
        ...
        return majorService.addMajorInfo(addMajorInfoQuery,loginUser.getApiInfo().getUserId(),loginUser.getApiInfo().getUserName());
    }
    ...
    public Result<List<MajorAmountVO>> queryMajorInfoByAPI(@Valid @Param("departId") String departId,@Valid @Param("planId")Long planId) throws MyExcption {
        ...
        List<MajorAmountVO> majors = majorService.queryMajorInfoByAPI(result, loginUser.getCurrentSchoolId(),loginUser.getCurrentSemesterId());
