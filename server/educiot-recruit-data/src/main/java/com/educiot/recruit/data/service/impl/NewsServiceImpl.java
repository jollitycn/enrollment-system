...
/**
     ...
     */
    @Override
    public Boolean addOrEditNews(AddOrEditNewsReq addOrEditNewsReq,Long recruitSchoolId,Long userId,String userName) {
        ...
        if(CommonUtil.checkId(newsId)){
            ...
            news.setCreatorName(userName);
            news.setCreateTime(LocalDateTime.now());
            news.setRecruitSchoolId(recruitSchoolId);
