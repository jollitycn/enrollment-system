...
public class MajorServiceImpl extends ServiceImpl<MajorMapper, Major> implements IMajorService {
    ...
    @Override
    public Result addMajorInfo(AddMajorInfoQuery addMajorInfoQuery,Long userId,String userName) {
        LocalDateTime now = LocalDateTime.now();
        addMajorInfoQuery.setCreatorId(userId);
        addMajorInfoQuery.setCreatorName(userName);
...
//        }
    ...
    @Override
    public List<MajorAmountVO> queryMajorInfoByAPI(MajorListResult majorListResult, Long recruitSchoolId,Long currentSemesterId ) {
        ...
        majorListResult.getData().forEach(Major->{
            ...
            Integer integer = baseMapper.queryTargetAmount(recruitSchoolId, currentSemesterId, Major.getId());
