...
public interface IMajorService extends IService<Major> {
     ...
     * @return 返回是否添加成功装填
     */
    Result addMajorInfo(AddMajorInfoQuery addMajorInfoQuery,LoginUser loginUser);
     ...
     * @return 专业信息列表
     */
    List<MajorAmountVO> queryMajorInfoByAPI(MajorListResult majorListResult, LoginUser loginUser);
}
