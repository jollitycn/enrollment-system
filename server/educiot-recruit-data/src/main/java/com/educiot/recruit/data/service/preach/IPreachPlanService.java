...
public interface IPreachPlanService extends IService<PreachPlan> {
    Result<?> update(LoginUser loginUser, PreachPlanUpdateQuery query) throws MyExcption;

    Result<?> delete(LoginUser loginUser, Long id);

    Result<?> add(LoginUser loginUser, Long semesterId, String semesterName, PreachPlanAddQuery query) throws MyExcption;
