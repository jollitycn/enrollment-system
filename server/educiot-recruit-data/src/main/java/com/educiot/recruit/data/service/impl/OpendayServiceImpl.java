...
public class OpendayServiceImpl extends ServiceImpl<OpendayMapper, Openday> implements IOpendayService {
     ...
     */
    @Override
    public Result<?> addOrEditConsultationDay(Long userId,String userName, AddConsultationDayQuery addConsultationDayQuery) {
        ...
        if (addConsultationDayQuery.getOpendayId() == null) {
            ...
            openday.setCreatorId(userId);
            openday.setCreatorName(userName);
