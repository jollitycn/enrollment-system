...
public class GroupInfoServiceImpl extends ServiceImpl<GroupInfoMapper, GroupInfo> implements IGroupInfoService {
    ...
    @Override
    public Result addGroupInfo(AddGroupInfoQuery groupInfo, Long recruitSchoolId,Long userId,String userName) {
        // 校验学期是否已经存在
        ...
        insert.setCreatorName(userName);
        insert.setCreateTime(LocalDateTime.now());
        insert.setRecruitSchoolId(recruitSchoolId);
