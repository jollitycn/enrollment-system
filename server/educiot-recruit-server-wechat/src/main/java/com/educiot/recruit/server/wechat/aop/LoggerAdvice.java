...
public class LoggerAdvice {
    ...
    @Before("within(com.educiot.recruit.server.wechat..*) && @annotation(lm)")
    ...
    @AfterReturning("within(com.educiot.recruit.server.wechat..*) && @annotation(lm)")
    ...
    @AfterThrowing(pointcut = "within(com.educiot.recruit.server.wechat..*) && @annotation(lm)", throwing = "ex")
