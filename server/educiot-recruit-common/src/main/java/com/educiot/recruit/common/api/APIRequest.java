...
//    }
    ...
    public RequestResult login() throws MyExcption {
        ...
        String str = null;
            ...
            str = doPost(LOGIN_URL, map);

        RequestResult requestResult = JSON.parseObject(str, RequestResult.class);
        if (requestResult.isSuccess()|| requestResult.getStatus().equals(APIResult.SUCCCESS)) {
     ...
     * @return String
     */
    public String loadToken() throws MyExcption {
    ...
    private String doPost(String  u ,Map map ) throws MyExcption {
        String str = null;
        try {
            str= HttpClientUtil.doPost(u, map);
        } catch (Exception e) {
            throw new MyExcption(CodeMsg.API_FAILED,e);
        }
        return str;
    }
    /**
    ...
    public SchoolUserInfoResult schoolUserInfo() throws MyExcption {
        ...
        String str = doPost(USER_INFO, map);
    ...
    public OrgStructResult orgStruct(String schoolid) throws MyExcption {
        ...
        String str = doPost(STRUCT_URL, map);
    ...
    public DepartInfoResult departInfo(String schoolid) throws MyExcption  {
        ...
        map.put("FDToken", loadToken());
        map.put("schoolid", schoolid);
        String str = doPost(DEPART_URL, map);
    ...
    public TermInfoResult termInfo(String schoolid) throws MyExcption {
        ...
        map.put("FDToken", loadToken());
        map.put("schoolid", schoolid);
        String str = doPost(TERM_URL, map);
    ...
    public AddMajorResult addMajor(String major, String departid) throws MyExcption {
        ...
        String s = doPost(ADD_MAJOR_URL, map);
    ...
    private APIResult checkResult(APIResult result) throws MyExcption {
        if (result.isSuccess()) {
            ...
            if (result.getStatus() == CodeMsg.API_NOT_LOGIN.getRetCode()) {
                ...
                throw new MyExcption(result.getStatus(), result.getErrorMessage());
            }
        }
    }
    ...
    public MajorListResult majorList(String departid) throws MyExcption {
        ...
        map.put("FDToken", loadToken());
        map.put("departid", departid);
        String str = doPost(MAJOR_URL, map);
     ...
     * @return
     */
    public AddTermResult addTerm(TermInfo term) throws MyExcption {
        ...
        map.put("start",dateFormat1.format(term.getStart())) ;
        map.put("end", dateFormat1.format(term.getEnd()));
        String str = doPost(ADD_TERM_URL, map);
    ...
    public APIResult getSuperior(String userid, String name) throws MyExcption {
        ...
        map.put("name", name);
        String str = doPost(SUPERIOR_URL, map);
    ...
    public static void main(String args[]) throws Exception {
        ...
        APIRequest.apiUrl = "http://educiot.cn:2070/recruit";

        APIRequest request = new APIRequest("13613613605","051234");
