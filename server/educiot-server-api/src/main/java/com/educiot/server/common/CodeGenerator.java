...
class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/educiot-server-api/src/main/java");
        gc.setAuthor("JasonHong");
        ...
        dsc.setUrl("jdbc:mysql://100.168.2.55:3306/educiot?serverTimezone=Asia/Shanghai&characterEncoding=utf8");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/educiot-server-api/src/main/resources/mapper/"
