...
CREATE TABLE `e_r_news` (
  ...
  `message_content` varchar(4000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '消息内容',
  `recruit_school_id` bigint(20) DEFAULT NULL COMMENT '招生学校ID',
...
CREATE TABLE `e_r_student_public_relation` (
  ...
  `register_status` tinyint(4) DEFAULT NULL COMMENT '报名状态（0：已交订金，1：已交全款，2：已退款，3：强意向生，4：已报名）',
  `semester` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学期',
  `group_id` bigint(20) DEFAULT NULL COMMENT '招生组ID',
  `semester_id` bigint(20) DEFAULT NULL COMMENT '学期ID',
...
INSERT INTO `e_r_sys_dictionary` VALUES ('17', '16', 'maintain_school', '1', '计划发布，维护学校信息', 'maintain_school', '维护学校信息', '1', '1', '0', null, null, null, '1252559728180355074');
INSERT INTO `e_r_sys_dictionary` VALUES ('18', '16', 'maintain_preach', '1', '计划发布，维护宣讲计划', 'maintain_preach', '维护宣讲计划', '1', '1', '0', null, null, null, '1252559728180355074');
INSERT INTO `e_r_sys_dictionary` VALUES ('19', '16', 'preach_schdule', '1', '明天有宣讲任务', 'preach_schdule', '宣讲任务', '1', '1', '0', null, null, null, '1252559728180355074');
INSERT INTO `e_r_sys_dictionary` VALUES ('20', '16', 'request_deal', '1', '有新的诉求请处理', 'request_deal', '诉求处理', '1', '1', '0', null, null, null, '1252559728180355074');
INSERT INTO `e_r_sys_dictionary` VALUES ('21', '16', 'consultation_deal', '1', '有新的到校咨询请处理', 'consultation_deal', '到校咨询处理', '1', '1', '0', null, null, null, '1252559728180355074');
INSERT INTO `e_r_sys_dictionary` VALUES ('22', '16', 'admission', '1', '亲爱的{0}同学： 经学校招生委员会审查合格，同意你报读我校{1}科班专业{2}专业。请确认到校就读，并于2020年8月29日。按《入学须知》到校报到注册。', 'admission', '入学通知', '1', '1', '0', null, null, null, null);
