...
drop table if exists e_rt_preach_plan;

drop table if exists sys_region;


alter table e_r_aim_student comment '目标生表';
...
/*==============================================================*/
/* Table: e_rt_preach_plan                                      */
/*==============================================================*/
create table e_rt_preach_plan
(
...
alter table e_rt_preach_plan comment '招生宣讲计划';
...
alter table sys_region comment '系统地区表';
