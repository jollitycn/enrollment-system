/*
 ...
 Source Server         : 47.112.129.244
 Source Server Type    : MySQL
 Source Server Version : 50647
 Source Host           : 47.112.129.244:7306
 Source Schema         : educiotrecruit

 Target Server Type    : MySQL
 Target Server Version : 50647
 File Encoding         : 65001

 Date: 14/07/2020 15:23:28
*/
...
CREATE TABLE `e_r_aim_major`  (
  ...
  `student_public_relation_id` bigint(20) NULL DEFAULT NULL COMMENT '学生公关ID',
  `major_id` bigint(20) NULL DEFAULT NULL COMMENT '招生专业ID',
  `level` tinyint(4) NULL DEFAULT NULL COMMENT '志愿等级',
  `is_adjust` tinyint(4) NULL DEFAULT 0 COMMENT '是否接受调剂（0：不接受，1：接受）',
  PRIMARY KEY (`aim_major_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '选择专业表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_aim_major
-- ----------------------------
INSERT INTO `e_r_aim_major` VALUES (1281798053707120641, 1281777434508656641, 1281773599602024449, 1, 0);
INSERT INTO `e_r_aim_major` VALUES (1281798053711314946, 1281777434508656641, NULL, 2, 0);
INSERT INTO `e_r_aim_major` VALUES (1281798053711314947, 1281777434508656641, NULL, 3, 0);
...
CREATE TABLE `e_r_aim_student`  (
  ...
  `student_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学生姓名',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `student_telephone` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学生联系方式',
  `father_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '父亲姓名',
  `father_telephone` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '父亲联系方式',
  `mother_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '母亲姓名',
  `mother_telephone` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '母亲联系方式',
  `level` tinyint(4) NULL DEFAULT NULL COMMENT '公关等级（0：高，1：中，2：低）',
  `reason` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '意向原因',
  `direction` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '公关方向',
  `status` tinyint(4) NULL DEFAULT 0 COMMENT '状态（0：已报名，1：跟进中）',
  PRIMARY KEY (`aim_student_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '目标生表' ROW_FORMAT = Compact;
...
CREATE TABLE `e_r_charger`  (
  ...
  `group_id` bigint(20) NULL DEFAULT NULL COMMENT '招生组ID',
  `name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '姓名',
  `account` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '账号',
  `telephone` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '手机号',
  `status` tinyint(4) NULL DEFAULT NULL COMMENT '状态（0：删除，1：正常）',
  `is_leader` tinyint(4) NULL DEFAULT 0 COMMENT '是否是组长（0：否，1：是）',
  `api_id` bigint(20) NULL DEFAULT NULL COMMENT '接口ID',
  PRIMARY KEY (`charger_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生负责人' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_charger
-- ----------------------------
INSERT INTO `e_r_charger` VALUES (1281769831196041217, 1281769031770087425, '姚耀金', '15977222850', '15977222850', 0, 1, 2600711978163717663);
INSERT INTO `e_r_charger` VALUES (1281769881104064514, 1281769031770087425, '王佳乐', '15977222341', '15977222341', 0, 0, 408638764749505114);
INSERT INTO `e_r_charger` VALUES (1281769908635475970, 1281769084995805186, '宁采臣', '15977221546', '15977221546', 0, 1, -2862947336221274815);
INSERT INTO `e_r_charger` VALUES (1281772021709053954, 1281771918109745154, '王处长', '13613613604', '13613613604', 1, 1, 2238899772213054183);
INSERT INTO `e_r_charger` VALUES (1281772037982953473, 1281771918109745154, '郑小平', '13213213200', '13213213200', 1, 0, 3380979344860270082);
INSERT INTO `e_r_charger` VALUES (1281772098875858946, 1281771973537472513, '郭处长', '13613613605', '13613613605', 1, 1, 3745520413114911150);
INSERT INTO `e_r_charger` VALUES (1281853898969096194, 1281853808753811457, '姚耀金', '15977222850', '15977222850', 1, 1, 2600711978163717663);
INSERT INTO `e_r_charger` VALUES (1281853915809226753, 1281853808753811457, '王佳乐', '15977222341', '15977222341', 1, 0, 408638764749505114);
INSERT INTO `e_r_charger` VALUES (1281853995022852097, 1281853853884522497, '宁采臣', '15977221546', '15977221546', 1, 1, -2862947336221274815);
INSERT INTO `e_r_charger` VALUES (1281870699970994177, 1281870698901446658, '王处长', '13613613604', '13613613604', 1, 1, 2238899772213054183);
INSERT INTO `e_r_charger` VALUES (1281870700314927105, 1281870698901446658, '郑小平', '13213213200', '13213213200', 1, 0, 3380979344860270082);
INSERT INTO `e_r_charger` VALUES (1281870701690658817, 1281870701002792961, '郭处长', '13613613605', '13613613605', 1, 1, 3745520413114911150);
INSERT INTO `e_r_charger` VALUES (1282503335320002562, 1281853853884522497, '姚婷辖', '15977223997', '15977223997', 0, 0, 7403171138704984117);
INSERT INTO `e_r_charger` VALUES (1282503497710870530, 1281853853884522497, '姚婷辖', '15977223997', '15977223997', 0, 0, 7403171138704984117);
INSERT INTO `e_r_charger` VALUES (1282503708843745282, 1281853853884522497, '姚婷辖', '15977223997', '15977223997', 1, 0, 7403171138704984117);
INSERT INTO `e_r_charger` VALUES (1282937388996792321, 1282937388615110657, '王处长', '13613613604', '13613613604', 1, 1, 2238899772213054183);
INSERT INTO `e_r_charger` VALUES (1282937389105844225, 1282937388615110657, '郑小平', '13213213200', '13213213200', 1, 0, 3380979344860270082);
INSERT INTO `e_r_charger` VALUES (1282937389516886017, 1282937389302976513, '郭处长', '13613613605', '13613613605', 1, 1, 3745520413114911150);
...
CREATE TABLE `e_r_class`  (
  ...
  `source_school_id` bigint(20) NULL DEFAULT NULL COMMENT '生源学校ID',
  `class_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '班级名称',
  `level` tinyint(4) NULL DEFAULT NULL COMMENT '公关等级（0：高，1：中，2：低）',
  `adviser` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '班主任',
  `telephone` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系方式',
  `amount` int(11) NULL DEFAULT NULL COMMENT '学生人数',
  `willing_amount` int(11) NULL DEFAULT NULL COMMENT '意向生',
  `comment` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '说明',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `semester_id` bigint(20) NULL DEFAULT NULL COMMENT '学期ID',
  PRIMARY KEY (`class_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '班级表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_class
-- ----------------------------
INSERT INTO `e_r_class` VALUES (1281776446783647746, 1281771651859521538, '班级一', 0, '班主任', '13699995252', 51, 11, '说明', '2020-07-11 10:24:54', '王处长', 2238899772213054183, 6959578747970340926);
INSERT INTO `e_r_class` VALUES (1281776552840818689, 1281771651859521538, '班级二', 1, '李四', '13899992222', 52, 10, NULL, '2020-07-11 10:25:19', '王处长', 2238899772213054183, 6959578747970340926);
INSERT INTO `e_r_class` VALUES (1281776670809812994, 1281771651859521538, '班级三', 2, '主任班', '13855554444', 54, 17, '说明', '2020-07-11 10:25:47', '王处长', 2238899772213054183, 6959578747970340926);
INSERT INTO `e_r_class` VALUES (1281874401825914882, 1281771651855327234, '班级一', 0, '主任王', '13699992525', 19, 8, NULL, '2020-07-11 16:54:08', '王处长', 2238899772213054183, 4478489728732514178);
INSERT INTO `e_r_class` VALUES (1282936217284395010, 1281771651859521539, '测试班级1', 1, '测试班主任名称', '13333333333', 222, 222, NULL, '2020-07-14 15:13:25', '郭处长', 3745520413114911150, 4478489728732514178);
INSERT INTO `e_r_class` VALUES (1282938206181408770, 1281771651859521539, '测试班级2', 0, '大玩法为', '13333333333', 222, 222, NULL, '2020-07-14 15:21:19', '郭处长', 3745520413114911150, 3798241326724759975);
...
CREATE TABLE `e_r_college`  (
  ...
  `api_id` bigint(20) NULL DEFAULT NULL COMMENT '接口ID',
  `college_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '院系名称',
  `college_manager` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '院系负责人',
  `recruit_amount` int(11) NULL DEFAULT NULL COMMENT '招生人数',
  `recruit_target` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '招生对象',
  `cultivate_aim` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '培养目标',
  `main_course` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '主要课程',
  `career_forward` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '就业方向',
  `comment` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '院系简介',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `plan_id` bigint(20) NULL DEFAULT NULL COMMENT '计划ID',
  `recruit_school_id` bigint(20) NULL DEFAULT NULL COMMENT '招生学校ID',
  `api_college_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '接口院系名称',
  PRIMARY KEY (`college_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生院系表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_college
-- ----------------------------
INSERT INTO `e_r_college` VALUES (1281772905440518146, -5552494227726187922, 'Java', '李小四', 200, '招生的对象', '培养的目标', NULL, '就业的方向', '<p><img src=\"/admin/static/e40ef5a9-6c8b-42d5-af05-efb0ceb4c0fe2.jpg\"></p>', 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281772903989288962, 1281771392886415362, 'Java');
INSERT INTO `e_r_college` VALUES (1281772905776062465, -4707823322812559367, '招生', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281772903989288962, 1281771392886415362, '招生');
INSERT INTO `e_r_college` VALUES (1281772906107412481, -2578475429000756138, '文综', '王小五', 5800, '招生对象', '目标培养', NULL, '方向就业', '<p>简介</p>', 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281772903989288962, 1281771392886415362, '文综');
INSERT INTO `e_r_college` VALUES (1281772906438762497, -824708636807314491, '测试', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281772903989288962, 1281771392886415362, '测试');
INSERT INTO `e_r_college` VALUES (1281772906770112514, 593214709207353276, '理综', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281772903989288962, 1281771392886415362, '理综');
INSERT INTO `e_r_college` VALUES (1281772907109851138, 1953118350262554094, '基础', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281772903989288962, 1281771392886415362, '基础');
INSERT INTO `e_r_college` VALUES (1281854514416099329, -4055519447386534861, '高考', '院系负责人', 200, '招生的对象', '目标的培养', NULL, '就业的方向', '<p>院系的简介</p>', -882429540250137944, '刘雍星', '2020-07-11 15:35:07', 1281854513149419521, 1281767950533042178, '高考');
INSERT INTO `e_r_college` VALUES (1281854514726477825, -2812866589434164485, '艺术特长', NULL, NULL, NULL, NULL, NULL, NULL, NULL, -882429540250137944, '刘雍星', '2020-07-11 15:35:07', 1281854513149419521, 1281767950533042178, '艺术特长');
INSERT INTO `e_r_college` VALUES (1281854515045244930, -473512388439879874, '信息技术', NULL, NULL, NULL, NULL, NULL, NULL, NULL, -882429540250137944, '刘雍星', '2020-07-11 15:35:07', 1281854513149419521, 1281767950533042178, '信息技术');
INSERT INTO `e_r_college` VALUES (1281854515355623426, 2004803501152027269, '机电商贸', NULL, NULL, NULL, NULL, NULL, NULL, NULL, -882429540250137944, '刘雍星', '2020-07-11 15:35:07', 1281854513149419521, 1281767950533042178, '机电商贸');
INSERT INTO `e_r_college` VALUES (1281871324695797762, -5552494227726187922, 'Java', '李小四', 200, '招生的对象', '培养的目标', NULL, '就业的方向', '<p><img src=\"/admin/static/e40ef5a9-6c8b-42d5-af05-efb0ceb4c0fe2.jpg\"></p>', 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281871323156488193, 1281771392886415362, 'Java');
INSERT INTO `e_r_college` VALUES (1281871325891174402, -4707823322812559367, '招生', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281871323156488193, 1281771392886415362, '招生');
INSERT INTO `e_r_college` VALUES (1281871326402879489, -2578475429000756138, '文综', '王小五', 5800, '招生对象', '目标培养', NULL, '方向就业', '<p>简介</p>', 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281871323156488193, 1281771392886415362, '文综');
INSERT INTO `e_r_college` VALUES (1281871327254323202, -824708636807314491, '测试', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281871323156488193, 1281771392886415362, '测试');
INSERT INTO `e_r_college` VALUES (1281871327761833986, 593214709207353276, '理综', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281871323156488193, 1281771392886415362, '理综');
INSERT INTO `e_r_college` VALUES (1281871328273539073, 1953118350262554094, '基础', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1281871323156488193, 1281771392886415362, '基础');
INSERT INTO `e_r_college` VALUES (1282937309476982785, -5552494227726187922, 'Java', '李小四', 200, '招生的对象', '培养的目标', NULL, '就业的方向', '<p><img src=\"/admin/static/e40ef5a9-6c8b-42d5-af05-efb0ceb4c0fe2.jpg\"></p>', 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1282937308629733378, 1281771392886415362, 'Java');
INSERT INTO `e_r_college` VALUES (1282937309879635969, -4707823322812559367, '招生', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1282937308629733378, 1281771392886415362, '招生');
INSERT INTO `e_r_college` VALUES (1282937310026436610, -2578475429000756138, '文综', '王小五', 5800, '招生对象', '目标培养', NULL, '方向就业', '<p>简介</p>', 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1282937308629733378, 1281771392886415362, '文综');
INSERT INTO `e_r_college` VALUES (1282937310282289154, -824708636807314491, '测试', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1282937308629733378, 1281771392886415362, '测试');
INSERT INTO `e_r_college` VALUES (1282937310429089793, 593214709207353276, '理综', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1282937308629733378, 1281771392886415362, '理综');
INSERT INTO `e_r_college` VALUES (1282937310584279042, 1953118350262554094, '基础', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2238899772213054183, '王处长', '2020-07-11 10:10:50', 1282937308629733378, 1281771392886415362, '基础');
...
CREATE TABLE `e_r_communication_record`  (
  ...
  `student_public_relation_id` bigint(20) NULL DEFAULT NULL COMMENT '学生公关ID',
  `communication_date` date NULL DEFAULT NULL COMMENT '沟通日期',
  `communication_way` tinyint(4) NULL DEFAULT NULL COMMENT '沟通方式（0：电话，1：微信，2：见面）',
  `communication_result` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '沟通结果',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`communication_record_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '沟通记录' ROW_FORMAT = Compact;
...
CREATE TABLE `e_r_consultation`  (
  ...
  `semester` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学期',
  `daily_receptionist_id` bigint(20) NULL DEFAULT NULL COMMENT '日常接待人ID',
  `daily_receptionist_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '日常接待人名称',
  `telephone` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系方式',
  `schedule` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '接待行程',
  `address` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '接待地址',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `semester_id` bigint(20) NULL DEFAULT NULL COMMENT '学期ID',
  PRIMARY KEY (`consultation_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '到校咨询表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_consultation
-- ----------------------------
INSERT INTO `e_r_consultation` VALUES (1281775319430242305, '2020-07-11', '2020-07-18', '招生计划--上学期', 3745520413114911150, '郭处长', '13613613604', '<p>接待的行程</p>', '<p>接待的地址</p>', 2238899772213054183, '王处长', '2020-07-11 13:14:34', 6959578747970340926);
INSERT INTO `e_r_consultation` VALUES (1281855553286479873, '2020-07-16', '2020-07-23', '北京大学上学期', 2, '', '13030303300', '<p>行程..................................</p>', '<p>地址...................................</p>', -882429540250137944, '刘雍星', '2020-07-11 15:39:14', 7201704839644991172);
INSERT INTO `e_r_consultation` VALUES (1281876800850403330, '2020-07-23', '2020-07-30', '招生计划--下学期', 2, '', '13899996666', '<p>888</p>', '<p>9999</p>', 2238899772213054183, '王处长', '2020-07-11 17:03:40', 4478489728732514178);
...
CREATE TABLE `e_r_consultation_feedback`  (
  ...
  `consultation_id` bigint(20) NULL DEFAULT NULL COMMENT '到校咨询ID',
  `consultation_date` date NULL DEFAULT NULL COMMENT '咨询日期',
  `consultation_content` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '反馈内容',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `summary` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '总结',
  PRIMARY KEY (`consultation_feedback_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '咨询反馈表' ROW_FORMAT = Compact;
...
CREATE TABLE `e_r_consultation_register`  (
  ...
  `consultation_id` bigint(20) NULL DEFAULT NULL COMMENT '到校咨询ID',
  `consultation_type` tinyint(4) NULL DEFAULT NULL COMMENT '咨询类型（0：个人，1：学校）',
  `source_school_id` bigint(20) NULL DEFAULT NULL COMMENT '生源学校ID',
  `is_openday` tinyint(4) NULL DEFAULT NULL COMMENT '是否接待日（0：是，1：否）',
  `class_id` bigint(20) NULL DEFAULT NULL COMMENT '班级ID',
  `telephone` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系方式',
  `consultation_date` date NULL DEFAULT NULL COMMENT '咨询日期',
  `attend_time` datetime(0) NULL DEFAULT NULL COMMENT '到校时间',
  `is_lunch` tinyint(4) NULL DEFAULT NULL COMMENT '是否用餐（0：是，1：否）',
  `comment` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '说明',
  `teacher` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '带队老师',
  `amount` int(11) NULL DEFAULT NULL COMMENT '人数',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人（负责人）',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称（负责人名称）',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `student_public_relation_id` bigint(20) NULL DEFAULT NULL COMMENT '学生公关ID',
  `student_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学生姓名',
  `is_attend` tinyint(4) NULL DEFAULT 0 COMMENT '是否签到（0：否，1：是）',
  PRIMARY KEY (`consultation_register_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生咨询登记表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_consultation_register
-- ----------------------------
INSERT INTO `e_r_consultation_register` VALUES (1281776858588803074, 1281775319430242305, 1, 1281771651855327234, NULL, NULL, '13852523434', '2020-07-14', '2020-07-14 11:06:00', 1, '', '黑旋风', 13, 2238899772213054183, '王处长', '2020-07-11 10:26:32', 0, '', 0);
INSERT INTO `e_r_consultation_register` VALUES (1281790726107066369, 1281775319430242305, 0, 1281771651859521538, NULL, 1281776670809812994, '13855552323', '2020-07-13', '2020-07-13 09:05:00', 0, '', '', 1, 2238899772213054183, '王处长', '2020-07-11 11:21:38', 1281777434508656641, '郑平', 0);
INSERT INTO `e_r_consultation_register` VALUES (1281838074212384769, 1281775319430242305, 0, 1281771651859521538, NULL, 1281776670809812994, '13899995252', '2020-07-14', '2020-07-14 09:00:00', 0, '', NULL, NULL, 2238899772213054183, NULL, '2020-07-11 14:29:47', 1281777434508656641, '郑平', 0);
...
CREATE TABLE `e_r_exception_log`  (
  `exc_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '异常记录主键id',
  `exc_requ_param_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作方法',
  `exc_requ_param` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '请求参数',
  `exc_name` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '异常名称',
  ...
  `oper_user_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作人名称',
  `oper_uri` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '请求URI',
  `oper_ip` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '请求IP',
  `oper_ver` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作版本号',
...
-- ----------------------------
INSERT INTO `e_r_exception_log` VALUES ('1374a42c3a756f555af7c2ceea2b55b0', NULL, NULL, 'org.springframework.web.method.annotation.MethodArgumentTypeMismatchException: Failed to c', 'Failed to convert value of type \'java.lang.String\' to required type \'java.lang.Long\'; nested exception is java.lang.NumberFormatException: For input string: \"undefined\"', NULL, NULL, '/consultation/getConsultationDetail/undefined', '127.0.0.1', '0.1.7', '2020-07-11 12:58:19');
INSERT INTO `e_r_exception_log` VALUES ('192d2367dad004e6313ad9309a9f0808', NULL, NULL, 'org.springframework.web.method.annotation.MethodArgumentTypeMismatchException: Failed to c', 'Failed to convert value of type \'java.lang.String\' to required type \'java.lang.Long\'; nested exception is java.lang.NumberFormatException: For input string: \"undefined\"', NULL, NULL, '/consultation/getConsultationDetail/undefined', '127.0.0.1', '0.1.7', '2020-07-11 12:58:38');
INSERT INTO `e_r_exception_log` VALUES ('266f15f70e29bfd3fad9c94445e8653b', NULL, NULL, 'java.lang.NullPointerException', 'com.educiot.recruit.data.service.impl.SysDictionaryServiceImpl.getDictListByCode(SysDictionaryServiceImpl.java:220)', NULL, NULL, '/news/getMessageTypeList', '127.0.0.1', '0.1.7', '2020-07-11 09:46:04');
INSERT INTO `e_r_exception_log` VALUES ('328eee4bb14a150d62b93e56bc346029', NULL, NULL, 'org.springframework.web.method.annotation.MethodArgumentTypeMismatchException: Failed to c', 'Failed to convert value of type \'java.lang.String\' to required type \'java.lang.Long\'; nested exception is java.lang.NumberFormatException: For input string: \"undefined\"', NULL, NULL, '/consultation/getConsultationDetail/undefined', '127.0.0.1', '0.1.7', '2020-07-11 11:32:39');
INSERT INTO `e_r_exception_log` VALUES ('3e4b7c9bbf61ba02f9f74286d7790681', 'FROM', '{\"schoolId\":[\"1\"]}', 'MyExcption(code=500106, msg=登录失效，请重新登录！)', '登录失效，请重新登录！', NULL, NULL, '/api/sys/term/info', '127.0.0.1', '0.1.7', '2020-07-13 15:16:47');
INSERT INTO `e_r_exception_log` VALUES ('421168e91ad9192e100cfb9c35db5f7a', NULL, NULL, 'org.springframework.web.method.annotation.MethodArgumentTypeMismatchException: Failed to c', 'Failed to convert value of type \'java.lang.String\' to required type \'java.lang.Long\'; nested exception is java.lang.NumberFormatException: For input string: \"undefined\"', NULL, NULL, '/consultation/getConsultationDetail/undefined', '127.0.0.1', '0.1.7', '2020-07-11 11:32:50');
INSERT INTO `e_r_exception_log` VALUES ('45ed3403a3659bc10d347d0571a0db19', NULL, NULL, 'org.springframework.web.method.annotation.MethodArgumentTypeMismatchException: Failed to c', 'Failed to convert value of type \'java.lang.String\' to required type \'java.lang.Long\'; nested exception is java.lang.NumberFormatException: For input string: \"undefined\"', NULL, NULL, '/consultation/getConsultationDetail/undefined', '127.0.0.1', '0.1.7', '2020-07-11 13:01:13');
INSERT INTO `e_r_exception_log` VALUES ('49605677425e79237c0c7e4977ed77c4', NULL, NULL, 'org.springframework.web.method.annotation.MethodArgumentTypeMismatchException: Failed to c', 'Failed to convert value of type \'java.lang.String\' to required type \'java.lang.Long\'; nested exception is java.lang.NumberFormatException: For input string: \"undefined\"', NULL, NULL, '/consultation/getConsultationDetail/undefined', '127.0.0.1', '0.1.7', '2020-07-11 11:32:33');
INSERT INTO `e_r_exception_log` VALUES ('5ce00015b70b7f125c05a31669d6f615', NULL, NULL, 'org.springframework.web.method.annotation.MethodArgumentTypeMismatchException: Failed to c', 'Failed to convert value of type \'java.lang.String\' to required type \'java.lang.Long\'; nested exception is java.lang.NumberFormatException: For input string: \"undefined\"', NULL, NULL, '/consultation/getConsultationDetail/undefined', '127.0.0.1', '0.1.7', '2020-07-11 11:32:29');
INSERT INTO `e_r_exception_log` VALUES ('613c109dc302d694dc6c28ff3ce8e99f', NULL, NULL, 'org.springframework.web.method.annotation.MethodArgumentTypeMismatchException: Failed to c', 'Failed to convert value of type \'java.lang.String\' to required type \'java.lang.Long\'; nested exception is java.lang.NumberFormatException: For input string: \"undefined\"', NULL, NULL, '/consultation/getConsultationDetail/undefined', '127.0.0.1', '0.1.7', '2020-07-11 11:34:34');
INSERT INTO `e_r_exception_log` VALUES ('7bbb3d25c2097eb74c3f1770b799faa5', NULL, NULL, 'java.lang.NullPointerException', 'com.educiot.recruit.data.service.impl.SysDictionaryServiceImpl.getDictListByCode(SysDictionaryServiceImpl.java:220)', NULL, NULL, '/news/getMessageTypeList', '127.0.0.1', '0.1.7', '2020-07-11 09:45:45');
INSERT INTO `e_r_exception_log` VALUES ('7ca18b3cd17f6e7610f6a7aa1ae000ed', 'FROM', '{\"schoolId\":[\"201005\"]}', 'MyExcption(code=500106, msg=登录失效，请重新登录！)', '登录失效，请重新登录！', NULL, NULL, '/api/sys/term/info', '127.0.0.1', '0.1.7', '2020-07-14 11:18:33');
INSERT INTO `e_r_exception_log` VALUES ('accecf2197b9a574879712a4fda16dca', NULL, NULL, 'java.lang.NullPointerException', 'com.educiot.recruit.data.service.impl.SysDictionaryServiceImpl.getDictListByCode(SysDictionaryServiceImpl.java:220)', NULL, NULL, '/news/getMessageTypeList', '127.0.0.1', '0.1.7', '2020-07-11 09:45:41');
INSERT INTO `e_r_exception_log` VALUES ('b003576a0382479c65f5bb92b74c7647', NULL, NULL, 'java.lang.NullPointerException', 'com.educiot.recruit.data.service.impl.SysDictionaryServiceImpl.getDictListByCode(SysDictionaryServiceImpl.java:220)', NULL, NULL, '/news/getMessageTypeList', '127.0.0.1', '0.1.7', '2020-07-11 09:45:56');
INSERT INTO `e_r_exception_log` VALUES ('c3de88ffc5e5fbd3c0de6021534ae5ea', NULL, NULL, 'org.springframework.web.method.annotation.MethodArgumentTypeMismatchException: Failed to c', 'Failed to convert value of type \'java.lang.String\' to required type \'java.lang.Long\'; nested exception is java.lang.NumberFormatException: For input string: \"undefined\"', NULL, NULL, '/consultation/getConsultationDetail/undefined', '127.0.0.1', '0.1.7', '2020-07-11 13:32:14');
INSERT INTO `e_r_exception_log` VALUES ('db17f1b9aa640461207e9e9d167d39dd', 'FROM', '{\"schoolId\":[\"1\"]}', 'MyExcption(code=500106, msg=登录失效，请重新登录！)', '登录失效，请重新登录！', NULL, NULL, '/api/sys/term/info', '127.0.0.1', '0.1.7', '2020-07-13 16:22:30');
INSERT INTO `e_r_exception_log` VALUES ('fa881e27751b7342d46727a7992d225b', NULL, NULL, 'org.springframework.web.method.annotation.MethodArgumentTypeMismatchException: Failed to c', 'Failed to convert value of type \'java.lang.String\' to required type \'java.lang.Long\'; nested exception is java.lang.NumberFormatException: For input string: \"undefined\"', NULL, NULL, '/consultation/getConsultationDetail/undefined', '127.0.0.1', '0.1.7', '2020-07-11 13:48:35');
...
CREATE TABLE `e_r_family_member`  (
  ...
  `student_info` bigint(20) NULL DEFAULT NULL COMMENT '学生基本信息ID',
  `relation` tinyint(4) NULL DEFAULT NULL COMMENT '关系（0：父亲，1：母亲）',
  `name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '家长姓名',
  `company` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '工作单位',
  `position` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '职务',
  `telephone` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系方式',
  `location` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '户籍所在地',
  PRIMARY KEY (`family_member_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '家庭成员表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_family_member
-- ----------------------------
INSERT INTO `e_r_family_member` VALUES (1281779352165445634, 1281777433648824322, 1, '父亲', '育联网', '植物', '13866663333', '安徽省/芜湖市/弋江区');
INSERT INTO `e_r_family_member` VALUES (1281779352173834241, 1281777433648824322, 0, '母亲', '单位', '植物', '13622223333', '福建省/南平市/邵武市');
INSERT INTO `e_r_family_member` VALUES (1282481399856627714, 1282472238045462529, 0, '测试', '', '', '', '');
INSERT INTO `e_r_family_member` VALUES (1282481400024399874, 1282472238045462529, 1, '231', '', '', '', '');
...
CREATE TABLE `e_r_group`  (
  ...
  `name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '组别名称',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `comment` varchar(4000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '说明',
  `dept_id` bigint(20) NULL DEFAULT NULL COMMENT '所属部门（来着api组织结构）',
  `dept_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '部门名称',
  `area_id` bigint(20) NULL DEFAULT NULL COMMENT '所在区域（来着数据字典）',
  `status` tinyint(4) NULL DEFAULT 1 COMMENT '状态（0：删除，1：正常）',
  `target_amount` int(11) NULL DEFAULT NULL COMMENT '招生目标数量',
  PRIMARY KEY (`group_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生组表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_group
-- ----------------------------
INSERT INTO `e_r_group` VALUES (1281769031770087425, 1281768945753300993, '小组1', -882429540250137944, '刘雍星', '2020-07-11 09:55:26', '', 1805060844650054408, '区域招生组长', 1281767950533042186, 0, 150);
INSERT INTO `e_r_group` VALUES (1281769084995805186, 1281768945753300993, '小组2', -882429540250137944, '刘雍星', '2020-07-11 09:55:39', '', 232944595643679648, '招生处处长', 1281767950533042186, 0, 150);
INSERT INTO `e_r_group` VALUES (1281771918109745154, 1281771731408691202, '王处长的小组', 2238899772213054183, '王处长', '2020-07-11 10:06:54', '', 7410306899625790099, '招生处处长', 1281771392886415369, 1, 200);
INSERT INTO `e_r_group` VALUES (1281771973537472513, 1281771731408691202, '郭处长的小组', 2238899772213054183, '王处长', '2020-07-11 10:07:07', '', 6556084228381558762, '招生处副处长', 1281771392886415368, 1, 100);
INSERT INTO `e_r_group` VALUES (1281794064647233538, 1281771731408691202, '测试删除', 2238899772213054183, '王处长', '2020-07-11 11:34:54', '', 769572119093134808, '区域招生组长', 1281771392886415369, 0, 0);
INSERT INTO `e_r_group` VALUES (1281853808753811457, 1281852333562568705, '第一小组', -882429540250137944, '刘雍星', '2020-07-11 15:32:18', '', 2724798727415023255, '网络招生专员', 1281767950533042185, 1, 350);
INSERT INTO `e_r_group` VALUES (1281853853884522497, 1281852333562568705, '第二小组', -882429540250137944, '刘雍星', '2020-07-11 15:32:29', '', -1464917688220299631, '区域招生专员', 1281767950533042185, 1, 150);
INSERT INTO `e_r_group` VALUES (1281870698901446658, 1281870698381352962, '王处长的小组', 2238899772213054183, '王处长', '2020-07-11 10:06:54', '', 7410306899625790099, '招生处处长', 1281771392886415369, 1, 250);
INSERT INTO `e_r_group` VALUES (1281870701002792961, 1281870698381352962, '郭处长的小组', 2238899772213054183, '王处长', '2020-07-11 10:07:07', '', 6556084228381558762, '招生处副处长', 1281771392886415368, 1, 150);
INSERT INTO `e_r_group` VALUES (1281870702378524674, 1281870698381352962, '测试删除', 2238899772213054183, '王处长', '2020-07-11 11:34:54', '', 769572119093134808, '区域招生组长', 1281771392886415369, 0, 0);
INSERT INTO `e_r_group` VALUES (1282937388615110657, 1282937388426366977, '王处长的小组', 2238899772213054183, '王处长', '2020-07-11 10:06:54', '', 7410306899625790099, '招生处处长', 1281771392886415369, 1, 250);
INSERT INTO `e_r_group` VALUES (1282937389302976513, 1282937388426366977, '郭处长的小组', 2238899772213054183, '王处长', '2020-07-11 10:07:07', '', 6556084228381558762, '招生处副处长', 1281771392886415368, 1, 150);
INSERT INTO `e_r_group` VALUES (1282937389705629698, 1282937388426366977, '测试删除', 2238899772213054183, '王处长', '2020-07-11 11:34:54', '', 769572119093134808, '区域招生组长', 1281771392886415369, 0, 0);
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生组信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_group_info
-- ----------------------------
INSERT INTO `e_r_group_info` VALUES (1281768945753300993, '湖南大学2041年招生', '废弃--勿用', '', -882429540250137944, '刘雍星', '2020-07-11 09:55:05', 1281767950533042178, -5892329399024400876);
INSERT INTO `e_r_group_info` VALUES (1281771731408691202, '招生计划--上学期', '招生区域--上学期', '', 2238899772213054183, '王处长', '2020-07-11 10:06:10', 1281771392886415362, 6959578747970340926);
INSERT INTO `e_r_group_info` VALUES (1281852333562568705, '北京大学上学期', '招生区域--北京大学上学期', '', -882429540250137944, '刘雍星', '2020-07-11 15:26:27', 1281767950533042178, 7201704839644991172);
INSERT INTO `e_r_group_info` VALUES (1281870698381352962, '招生计划--下学期', '招生区域--下学期', '', 2238899772213054183, '王处长', '2020-07-11 16:39:25', 1281771392886415362, 4478489728732514178);
INSERT INTO `e_r_group_info` VALUES (1282937388426366977, '招生计划--第三学期', '招生区域--下学期', '', 2238899772213054183, '王处长', '2020-07-14 15:18:04', 1281771392886415362, 3798241326724759975);
...
CREATE TABLE `e_r_group_source_relation`  (
  ...
  `source_school_id` bigint(20) NULL DEFAULT NULL COMMENT '生源学校ID',
  `semester_id` bigint(20) NULL DEFAULT NULL COMMENT '学期ID',
  PRIMARY KEY (`group_source_relation_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生组生源学校关联表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_group_source_relation
-- ----------------------------
INSERT INTO `e_r_group_source_relation` VALUES (1281772055087325185, 1281771918109745154, 1281771651855327234, 6959578747970340926);
INSERT INTO `e_r_group_source_relation` VALUES (1281772063555624962, 1281771918109745154, 1281771651859521538, 6959578747970340926);
INSERT INTO `e_r_group_source_relation` VALUES (1281772125400637442, 1281771973537472513, 1281771651859521539, 6959578747970340926);
INSERT INTO `e_r_group_source_relation` VALUES (1281853955105660930, 1281853808753811457, 1281850986440204289, 7201704839644991172);
INSERT INTO `e_r_group_source_relation` VALUES (1281854015927263234, 1281853853884522497, 1281851243878195201, 7201704839644991172);
INSERT INTO `e_r_group_source_relation` VALUES (1281870699102773249, 1281870698901446658, 1281771651855327234, 4478489728732514178);
INSERT INTO `e_r_group_source_relation` VALUES (1281870699446706177, 1281870698901446658, 1281771651859521538, 4478489728732514178);
INSERT INTO `e_r_group_source_relation` VALUES (1281870701174759426, 1281870701002792961, 1281771651859521539, 4478489728732514178);
INSERT INTO `e_r_group_source_relation` VALUES (1282503585044668418, 1281853808753811457, 1281851105264836610, 7201704839644991172);
INSERT INTO `e_r_group_source_relation` VALUES (1282937388711579649, 1282937388615110657, 1281771651855327234, 3798241326724759975);
INSERT INTO `e_r_group_source_relation` VALUES (1282937388816437250, 1282937388615110657, 1281771651859521538, 3798241326724759975);
INSERT INTO `e_r_group_source_relation` VALUES (1282937389357502466, 1282937389302976513, 1281771651859521539, 3798241326724759975);
...
CREATE TABLE `e_r_in_school`  (
  ...
  `school_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '原学籍号',
  `talent` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '特长',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `student_info` bigint(20) NULL DEFAULT NULL COMMENT '学生基本信息ID',
  PRIMARY KEY (`in_school_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学生在校信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_in_school
-- ----------------------------
INSERT INTO `e_r_in_school` VALUES (1281778043479654401, '3695253', '', 1281777433648824322, '郑平', '2020-07-11 10:31:14', 1281777433648824322);
...
CREATE TABLE `e_r_login`  (
  ...
  `openid` varchar(128) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL COMMENT 'openid',
  `login_type` tinyint(4) NULL DEFAULT NULL COMMENT '登录类型（0：学生，1：家长）',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '第一次登录时间',
  `mobile` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL COMMENT '联系方式',
  `last_time` datetime(0) NULL DEFAULT NULL COMMENT '最后一次登录时间',
  PRIMARY KEY (`login`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '登录表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_login
-- ----------------------------
INSERT INTO `e_r_login` VALUES (1281777434840006658, 'oL6Dn5ZtfqjSnW2Q_EYvAYUhmgIw', 0, '2020-07-11 10:28:49', '13294159015', '2020-07-11 18:02:11');
INSERT INTO `e_r_login` VALUES (1282936527931351041, 'oRfCd4ltDQrm-EF7gdKv5vf2JmCo', 0, '2020-07-14 15:14:39', '13534261840', '2020-07-14 15:22:03');
...
CREATE TABLE `e_r_login_relation`  (
  ...
  `student_info` bigint(20) NULL DEFAULT NULL COMMENT '学生基本信息ID',
  `login` bigint(20) NULL DEFAULT NULL COMMENT '登录ID',
  PRIMARY KEY (`login_relation_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '登录信息关联表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_login_relation
-- ----------------------------
INSERT INTO `e_r_login_relation` VALUES (1281777435167162370, 1281777433648824322, 1281777434840006658);
INSERT INTO `e_r_login_relation` VALUES (1282936528082345986, 1282936527277039617, 1282936527931351041);
...
CREATE TABLE `e_r_major`  (
  ...
  `college_id` bigint(20) NULL DEFAULT NULL COMMENT '院系ID',
  `api_id` bigint(20) NULL DEFAULT NULL COMMENT '接口ID',
  `major_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '专业名称',
  `api_major_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '专业名称',
  `recruit_amount` int(11) NULL DEFAULT NULL COMMENT '招生人数',
  `fee` float(20, 2) NULL DEFAULT NULL COMMENT '学费（元/学期）',
  `major_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学制',
  `cultivate_aim` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '培养目标',
  `main_course` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '主要课程',
  `career_forward` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '就业方向',
  `comment` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '专业简介',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`major_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生专业表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_major
-- ----------------------------
INSERT INTO `e_r_major` VALUES (1281773599602024449, 1281772905440518146, 1102334001898144998, '计算机11', NULL, 100, 5850.00, '4', '培养目标', '课程111', '方向1111', '<p>专业的简介<img src=\"/admin/static/c79e5896-9b38-415e-9ae0-88daf7c72b041.jpg\"></p>', 2238899772213054183, '王处长', '2020-07-11 10:13:35');
INSERT INTO `e_r_major` VALUES (1281773899838693378, 1281772905440518146, 7281651321522835354, '计算机22', NULL, 100, 5850.00, '4', '目标22', '课程22222', '方向22414', '<p>专业的简介<img src=\"/admin/static/61a35207-7e56-40ec-987e-f6cae05f54174.jpg\"></p>', 2238899772213054183, '王处长', '2020-07-11 10:14:47');
INSERT INTO `e_r_major` VALUES (1281774192919879681, 1281772906107412481, -7581490097643175749, 'we弄', NULL, 100, 555.00, '1', '目标盘的', '归档', '搜嘎仍然会GV的', '<p>郭德纲国会大厦说的很对</p>', 2238899772213054183, '王处长', '2020-07-11 10:15:56');
INSERT INTO `e_r_major` VALUES (1281855087643238402, 1281854514416099329, 778536754874894074, '---专业1---', NULL, 100, 3000.00, '2', '培养目标', '课程主要', '就业方向的', '<p>专业的简介</p>', -882429540250137944, '刘雍星', '2020-07-11 15:37:23');
INSERT INTO `e_r_major` VALUES (1281855243038007298, 1281854514416099329, 778536754874894074, '---专业2---', NULL, 100, 4000.00, '3', '培养的目标', '课程信息', '方向就业', '<p>简介专业</p>', -882429540250137944, '刘雍星', '2020-07-11 15:38:00');
INSERT INTO `e_r_major` VALUES (1281871325211697153, 1281871324695797762, 1102334001898144998, '计算机11', NULL, 100, 5850.00, '4', '培养目标', '课程111', '方向1111', '<p>专业的简介<img src=\"/admin/static/c79e5896-9b38-415e-9ae0-88daf7c72b041.jpg\"></p>', 2238899772213054183, '王处长', '2020-07-11 10:13:35');
INSERT INTO `e_r_major` VALUES (1281871325551435777, 1281871324695797762, 7281651321522835354, '计算机22', NULL, 100, 5850.00, '4', '目标22', '课程22222', '方向22414', '<p>专业的简介<img src=\"/admin/static/61a35207-7e56-40ec-987e-f6cae05f54174.jpg\"></p>', 2238899772213054183, '王处长', '2020-07-11 10:14:47');
INSERT INTO `e_r_major` VALUES (1281871326914584577, 1281871326402879489, -7581490097643175749, 'we弄', NULL, 100, 555.00, '1', '目标盘的', '归档', '搜嘎仍然会GV的', '<p>郭德纲国会大厦说的很对</p>', 2238899772213054183, '王处长', '2020-07-11 10:15:56');
INSERT INTO `e_r_major` VALUES (1282937309682503682, 1282937309476982785, 1102334001898144998, '计算机11', NULL, 100, 5850.00, '4', '培养目标', '课程111', '方向1111', '<p>专业的简介<img src=\"/admin/static/c79e5896-9b38-415e-9ae0-88daf7c72b041.jpg\"></p>', 2238899772213054183, '王处长', '2020-07-11 10:13:35');
INSERT INTO `e_r_major` VALUES (1282937309787361282, 1282937309476982785, 7281651321522835354, '计算机22', NULL, 100, 5850.00, '4', '目标22', '课程22222', '方向22414', '<p>专业的简介<img src=\"/admin/static/61a35207-7e56-40ec-987e-f6cae05f54174.jpg\"></p>', 2238899772213054183, '王处长', '2020-07-11 10:14:47');
INSERT INTO `e_r_major` VALUES (1282937310173237250, 1282937310026436610, -7581490097643175749, 'we弄', NULL, 100, 555.00, '1', '目标盘的', '归档', '搜嘎仍然会GV的', '<p>郭德纲国会大厦说的很对</p>', 2238899772213054183, '王处长', '2020-07-11 10:15:56');
...
CREATE TABLE `e_r_news`  (
  ...
  `title` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '标题',
  `message_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '信息类型',
  `recevier` tinyint(4) NULL DEFAULT NULL COMMENT '接收端（0：全部，1：学生，2：家长）',
  `belong_plan` tinyint(4) NULL DEFAULT NULL COMMENT '所属计划（0：不限，1：已发布计划）',
  `message_content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '消息内容',
  `recruit_school_id` bigint(20) NULL DEFAULT NULL COMMENT '招生学校ID',
  `plan_id` bigint(20) NULL DEFAULT NULL COMMENT '招生计划ID',
  `news_status` tinyint(4) NULL DEFAULT 0 COMMENT '新闻状态（0：草稿，1：已发布）',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`news_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '新闻表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_news
-- ----------------------------
INSERT INTO `e_r_news` VALUES (1281846597776351233, '给学生的一封信', 'school_info', 1, NULL, '<p>你好，亲爱的学生</p>', 1281771392886415362, 1281772903989288962, 1, 2238899772213054183, '王处长', '2020-07-11 15:03:39');
...
CREATE TABLE `e_r_openday`  (
  ...
  `consultation_id` bigint(20) NULL DEFAULT NULL COMMENT '到校咨询ID',
  `receptionist_id` bigint(20) NULL DEFAULT NULL COMMENT '接待人ID',
  `receptionist_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '接待人名称',
  `amount` int(11) NULL DEFAULT NULL COMMENT '接待人数',
  `openday_date` date NULL DEFAULT NULL COMMENT '接待日期',
  `telephone` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系方式',
  `schedule` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '接待行程',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `is_openday` tinyint(4) NULL DEFAULT NULL COMMENT '是否是接待日（0：否，1：是，2：取消）',
  `address` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '接待地址',
  PRIMARY KEY (`openday_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '接待日信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_openday
-- ----------------------------
INSERT INTO `e_r_openday` VALUES (1281775398404792321, 1281775319430242305, 3380979344860270082, '郑小平', NULL, '2020-07-12', '13613613604', '<p>接待的行程</p>', 2238899772213054183, '王处长', '2020-07-11 10:20:44', 2, '<p>接待的地址</p>');
INSERT INTO `e_r_openday` VALUES (1281775481892413441, 1281775319430242305, 2238899772213054183, '王处长', NULL, '2020-07-13', '13613613604', '<p><img src=\"/admin/static/4bd2b684-97f3-4529-be38-bb5fa64732974.jpg\"></p>', 2238899772213054183, '王处长', '2020-07-11 10:21:04', 1, '<p><img src=\"/admin/static/d1edca6c-81e0-44f8-a44e-a6717e30c4833.jpg\"></p>');
INSERT INTO `e_r_openday` VALUES (1281775573869305858, 1281775319430242305, 3745520413114911150, '郭处长', NULL, '2020-07-14', '13613613605', '<p><img src=\"/admin/static/31e5eddc-1fc3-4b34-aefc-6ada211eae961.jpg\"></p>', 2238899772213054183, '王处长', '2020-07-11 10:21:26', 0, '<p><img src=\"/admin/static/2e2ffe15-07be-4fd4-9903-cd76c86ffaf22.jpg\"></p>');
...
CREATE TABLE `e_r_plan`  (
  ...
  `semester` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学期',
  `title` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '标题',
  `start_time` datetime(0) NULL DEFAULT NULL COMMENT '招生开始时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '招生结束时间',
  `charger_id` bigint(20) NULL DEFAULT NULL COMMENT '招生负责人ID',
  `charger_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '招生负责人名称',
  `publisher_id` bigint(20) NULL DEFAULT NULL COMMENT '发布人',
  `publisher_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '发布人名称',
  `publish_time` datetime(0) NULL DEFAULT NULL COMMENT '发布时间',
  `status` tinyint(4) NULL DEFAULT NULL COMMENT '状态（0：删除，1：未发布，2：已发布，3：已完成）',
  `is_defaulted` tinyint(4) NULL DEFAULT 0 COMMENT '是否默认（0：否，1：是）',
  `comment` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '说明',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `telephone_number` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系电话',
  `modifier_id` bigint(20) NULL DEFAULT NULL COMMENT '修改人id',
  `modify_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `copy_id` bigint(20) NULL DEFAULT NULL COMMENT '拷贝ID',
  `semester_id` bigint(20) NULL DEFAULT NULL COMMENT '学期ID',
  `semester_start` date NULL DEFAULT NULL COMMENT '学期开始时间',
  `semester_end` date NULL DEFAULT NULL COMMENT '学期结束时间',
  PRIMARY KEY (`plan_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生计划表 ' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_plan
-- ----------------------------
INSERT INTO `e_r_plan` VALUES (1281772903989288962, 1281771392886415362, 1, '招生计划--上学期', '2020年上学期', '2020-07-11 00:00:00', '2020-07-11 00:00:00', 1281772021709053954, NULL, 2238899772213054183, '王处长', '2020-07-11 10:16:02', 3, 0, '<p>基本说明</p>', 2238899772213054183, '王处长', '2020-07-11 10:10:49', '13613613604', NULL, NULL, NULL, 6959578747970340926, '2021-07-01', '2021-07-01');
INSERT INTO `e_r_plan` VALUES (1281854513149419521, 1281767950533042178, 0, '北京大学上学期', '春季招生', '2020-07-11 00:00:00', '2020-07-12 00:00:00', 1281853898969096194, NULL, -882429540250137944, '刘雍星', '2020-07-11 15:38:10', 2, 0, '<p>说明</p>', -882429540250137944, '刘雍星', '2020-07-11 15:35:06', '13622225555', NULL, NULL, NULL, 7201704839644991172, '2038-06-01', '2038-06-01');
INSERT INTO `e_r_plan` VALUES (1281871323156488193, 1281771392886415362, 3, '招生计划--下学期', '2020年下学期', '2020-07-11 00:00:00', '2020-07-11 00:00:00', 1281870701690658817, NULL, 2238899772213054183, '王处长', '2020-07-11 16:43:41', 2, 0, '<p>基本说明</p>', 2238899772213054183, '王处长', '2020-07-11 16:41:54', '13613613604', 2238899772213054183, NULL, 1281772903989288962, 4478489728732514178, '2022-07-07', '2022-07-07');
INSERT INTO `e_r_plan` VALUES (1282937308629733378, 1281771392886415362, 3, '招生计划--第三学期', '2020年---测试', '2020-07-11 00:00:00', '2020-07-11 00:00:00', 1282937389516886017, NULL, 3745520413114911150, '郭处长', '2020-07-14 15:19:19', 2, 0, '<p>基本说明</p>', 2238899772213054183, '王处长', '2020-07-14 15:17:45', '13613613604', 3745520413114911150, NULL, 1281871323156488193, 3798241326724759975, '2023-07-07', '2023-07-07');
...
CREATE TABLE `e_r_plan_recruit_info`  (
  ...
  `plan_id` bigint(20) NULL DEFAULT NULL COMMENT '招生计划ID',
  `recruit_target` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '招生对象',
  `attention` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '注意事项',
  `register` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '报到和录取',
  `plan_description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '招生计划',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `is_deleted` tinyint(4) NULL DEFAULT 0 COMMENT '是否删除（0：删除，1：正常）',
  `recruitment_image` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '招生简章',
  PRIMARY KEY (`plan_recruit_info_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生简介表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_plan_recruit_info
-- ----------------------------
INSERT INTO `e_r_plan_recruit_info` VALUES (1281772904727486466, 1281772903989288962, '招生的对象', '注意的事项！！！！', '报道录取', '<p>招生计划的简介<img src=\"/admin/static/948aa5b5-7a06-4c49-9751-23b7c003bd794.jpg\"></p>', NULL, NULL, NULL, 1, '2faca481-dc05-41bc-9f46-35c6b125f2f8清华.png');
INSERT INTO `e_r_plan_recruit_info` VALUES (1281854513770176514, 1281854513149419521, '招生的对象', '注意的事项', '报道和录取', '<p>招生的计划</p>', NULL, NULL, NULL, 1, '9a3c66e2-2976-4c27-a458-c8369ca4682e武汉工程大学.jpg');
INSERT INTO `e_r_plan_recruit_info` VALUES (1281871324175704066, 1281871323156488193, '招生的对象', '注意的事项！！！！', '报道录取', '<p>招生计划的简介<img src=\"/admin/static/948aa5b5-7a06-4c49-9751-23b7c003bd794.jpg\"></p>', NULL, NULL, NULL, 1, '2faca481-dc05-41bc-9f46-35c6b125f2f8清华.png');
INSERT INTO `e_r_plan_recruit_info` VALUES (1282937309187575810, 1282937308629733378, '招生的对象', '注意的事项！！！！', '报道录取', '<p>招生计划的简介<img src=\"/admin/static/948aa5b5-7a06-4c49-9751-23b7c003bd794.jpg\"></p>', NULL, NULL, NULL, 1, '2faca481-dc05-41bc-9f46-35c6b125f2f8清华.png');
...
CREATE TABLE `e_r_plan_school_introduction`  (
  ...
  `recruit_school_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '招生学校名称',
  `recruit_school_logo` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '招生学校logo',
  `is_deleted` tinyint(4) NULL DEFAULT 1 COMMENT '是否删除（0：删除，1：正常）',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `principal` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '校长名称',
  `telephone_number` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系电话',
  `address` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学校地址',
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '简介',
  `api_id` bigint(20) NULL DEFAULT NULL COMMENT '接口ID',
  `plan_id` bigint(20) NULL DEFAULT NULL COMMENT '招生计划ID',
  PRIMARY KEY (`plan_school_introduction_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生计划学校简介' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_plan_school_introduction
-- ----------------------------
INSERT INTO `e_r_plan_school_introduction` VALUES (1281772904366776322, '清华大学', 'bfe7877e-d69e-490d-827a-ac7262212e48清华.png', 1, NULL, '张三', '13613613605', '北京', '<p>学校简介<img src=\"/admin/static/28224329-32c4-478f-bcf4-e95cce717e64old.jpg\"></p>', NULL, 1281772903989288962);
INSERT INTO `e_r_plan_school_introduction` VALUES (1281854513459798017, '武汉工程大学', 'ab8de061-19c5-40a9-aa41-8b94aec9e92a武汉工程大学.jpg', 1, NULL, '张三', '13988885555', '学校地址', '<p>学校简介</p>', NULL, 1281854513149419521);
INSERT INTO `e_r_plan_school_introduction` VALUES (1281871323668193282, '清华大学', 'bfe7877e-d69e-490d-827a-ac7262212e48清华.png', 1, NULL, '张三', '13613613605', '北京', '<p>学校简介<img src=\"/admin/static/28224329-32c4-478f-bcf4-e95cce717e64old.jpg\"></p>', NULL, 1281871323156488193);
INSERT INTO `e_r_plan_school_introduction` VALUES (1282937309007220738, '清华大学', 'bfe7877e-d69e-490d-827a-ac7262212e48清华.png', 1, NULL, '张三', '13613613605', '北京', '<p>学校简介<img src=\"/admin/static/28224329-32c4-478f-bcf4-e95cce717e64old.jpg\"></p>', NULL, 1282937308629733378);
...
CREATE TABLE `e_r_preach_assistant_relation`  (
  ...
  `preach_plan_id` bigint(20) NULL DEFAULT NULL COMMENT '招生宣讲计划ID',
  `charger_id` bigint(20) NULL DEFAULT NULL COMMENT '负责人ID',
  `charger_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '负责人名称',
  PRIMARY KEY (`preach_assistant_relationt_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '宣讲协助人关联表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_preach_assistant_relation
-- ----------------------------
INSERT INTO `e_r_preach_assistant_relation` VALUES (1281780655797084162, 1281780655079858177, 3380979344860270082, '郑小平');
...
CREATE TABLE `e_r_preach_feedback`  (
  ...
  `student_public_relation_id` bigint(20) NULL DEFAULT NULL COMMENT '学生公关ID',
  `preach_plan_id` bigint(20) NULL DEFAULT NULL COMMENT '招生宣讲计划ID',
  `performance` tinyint(4) NULL DEFAULT NULL COMMENT '宣讲效果（0：好，1：一般，2：差）',
  `feedback_content` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '反馈内容',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`preach_feedback_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '宣讲反馈表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_preach_feedback
-- ----------------------------
INSERT INTO `e_r_preach_feedback` VALUES (1281833885117710338, 1281777434508656641, 1281780655079858177, 4, '靓仔', 1281777433648824322, '郑平', '2020-07-11 14:13:08');
...
CREATE TABLE `e_r_preach_plan`  (
  ...
  `semester` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学期',
  `preach_time` datetime(0) NULL DEFAULT NULL COMMENT '宣讲时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
  `speaker_id` bigint(20) NULL DEFAULT NULL COMMENT '主讲人ID',
  `speaker_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '主讲人名称',
  `plan_amount` int(11) NULL DEFAULT NULL COMMENT '计划人数',
  `telephone` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系方式',
  `title` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '主题',
  `address` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '宣讲地点',
  `comment` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '备注',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `semester_id` bigint(20) NULL DEFAULT NULL COMMENT '学期ID',
  `status` tinyint(4) NULL DEFAULT NULL COMMENT '状态（0：删除，1：草稿，2：已发布，3：已完成）',
  PRIMARY KEY (`preach_plan_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生宣讲计划' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_preach_plan
-- ----------------------------
INSERT INTO `e_r_preach_plan` VALUES (1281780655079858177, '招生计划--上学期', '2020-07-11 00:00:00', '2020-07-11 23:59:59', 2238899772213054183, '王处长', 18, '13613613604', '王处长的第一次宣讲', '学校操场', '这是第一次宣讲哦', 2238899772213054183, '王处长', '2020-07-11 10:41:37', 6959578747970340926, 2);
INSERT INTO `e_r_preach_plan` VALUES (1281842006733123585, '招生计划--上学期', '2020-07-12 00:00:00', '2020-07-12 00:00:00', 2238899772213054183, '王处长', 19, '13899996262', '第二次宣讲计划', '家里', '', 2238899772213054183, '王处长', '2020-07-11 14:45:25', 6959578747970340926, 2);
...
CREATE TABLE `e_r_preach_register`  (
  `preach_register_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '宣讲计划报名ID',
  `preach_plan_id` bigint(20) NULL DEFAULT NULL COMMENT '招生宣讲计划ID',
  `student_public_relation_id` bigint(20) NULL DEFAULT NULL COMMENT '学生公关ID',
  `status` tinyint(4) NULL DEFAULT NULL COMMENT '状态（0：报名，1：签到）',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `creator_id` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '创建人',
  PRIMARY KEY (`preach_register_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '宣讲计划报名表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_preach_register
-- ----------------------------
INSERT INTO `e_r_preach_register` VALUES ('1281780771262038017', 1281780655079858177, 1281777434508656641, 0, '2020-07-11 10:42:05', '1281777433648824322');
INSERT INTO `e_r_preach_register` VALUES ('1281780845081788417', 1281780655079858177, 1281777434508656641, 1, '2020-07-11 10:42:22', '1281777433648824322');
...
CREATE TABLE `e_r_preach_school_relation`  (
  ...
  `preach_plan_id` bigint(20) NULL DEFAULT NULL COMMENT '招生宣讲计划ID',
  `source_school_id` bigint(20) NULL DEFAULT NULL COMMENT '生源学校',
  PRIMARY KEY (`preach_school_relation_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '宣讲生源学校关联表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_preach_school_relation
-- ----------------------------
INSERT INTO `e_r_preach_school_relation` VALUES (1281780656484950018, 1281780655079858177, 1281771651855327234);
INSERT INTO `e_r_preach_school_relation` VALUES (1281780656484950019, 1281780655079858177, 1281771651859521538);
INSERT INTO `e_r_preach_school_relation` VALUES (1281780656484950020, 1281780655079858177, 1281771651859521539);
...
CREATE TABLE `e_r_preach_summary`  (
  ...
  `performance` tinyint(4) NULL DEFAULT NULL COMMENT '宣讲效果（0：好，1：一般，2：差）',
  `feedback_content` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '反馈内容',
  `summery` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '宣讲总结',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`preach_summary_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '宣讲总结表 ' ROW_FORMAT = Compact;
...
CREATE TABLE `e_r_progress`  (
  ...
  `student_public_relation_id` bigint(20) NULL DEFAULT NULL COMMENT '学生公关ID',
  `progress_type` tinyint(4) NULL DEFAULT NULL COMMENT '进度类型（0：报名登记，1：交费定位，2：接收通知，3：入学报名）',
  `progress_content` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '进度内容',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`progress_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学生报名进度表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_progress
-- ----------------------------
INSERT INTO `e_r_progress` VALUES (1281780771597582337, 1281777434508656641, 0, '宣讲报名', 1281777433648824322, '郑平', '2020-07-11 10:42:05');
INSERT INTO `e_r_progress` VALUES (1281780845413138434, 1281777434508656641, 0, '宣讲签到', 1281777433648824322, '郑平', '2020-07-11 10:42:23');
INSERT INTO `e_r_progress` VALUES (1281869086984241153, 1281777434508656641, 1, '已交全款', 2238899772213054183, '王处长', '2020-07-11 16:33:01');
INSERT INTO `e_r_progress` VALUES (1281869095569981442, 1281777434508656641, 1, '已退款', 2238899772213054183, '王处长', '2020-07-11 16:33:03');
INSERT INTO `e_r_progress` VALUES (1281869105745362946, 1281777434508656641, 1, '已交全款', 2238899772213054183, '王处长', '2020-07-11 16:33:05');

-- ----------------------------
-- Table structure for e_r_province
-- ----------------------------
DROP TABLE IF EXISTS `e_r_province`;
CREATE TABLE `e_r_province`  (
  `id` bigint(21) NOT NULL,
  `name` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '名称',
  `parentid` bigint(21) NULL DEFAULT NULL COMMENT '-1：顶级节点',
  `type` int(11) NULL DEFAULT 1 COMMENT '1：省\n2：市\n3：区\n4：县',
  `level` int(11) NULL DEFAULT 1,
  `owner` bigint(21) NULL DEFAULT 1 COMMENT '备用，不要处理',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `e_m_province_idx_level`(`level`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '省市区县' ROW_FORMAT = Compact;
...
CREATE TABLE `e_r_public_relation`  (
  ...
  `group_source_relation_id` bigint(20) NULL DEFAULT NULL COMMENT '招生组生源学校关联ID',
  `group_id` bigint(20) NULL DEFAULT NULL COMMENT '招生组ID',
  `source_school_id` bigint(20) NULL DEFAULT NULL COMMENT '生源学校',
  `start_time` datetime(0) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
  `contacter` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '沟通人',
  `telephone` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系方式',
  `content` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学校拜访内容',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人（负责人）',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称（负责人名称）',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`public_relation`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学校公关表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_public_relation
-- ----------------------------
INSERT INTO `e_r_public_relation` VALUES (1281797336141426689, 1281772055087325185, 1281771918109745154, 1281771651855327234, '2020-07-11 11:47:35', '2020-07-11 11:47:34', '嘿哈', '13888888888', '拜访你', 2238899772213054183, '王处长', '2020-07-11 11:47:54');
INSERT INTO `e_r_public_relation` VALUES (1282507022931066882, 1281772055087325185, 1281771918109745154, 1281771651855327234, '2020-07-13 10:47:36', '2020-07-13 10:47:36', '李四', '13699991111', '拜访', 2238899772213054183, '王处长', '2020-07-13 10:47:57');
...
CREATE TABLE `e_r_recruit_school`  (
  ...
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '简介',
  `api_id` bigint(20) NULL DEFAULT NULL COMMENT '接口ID',
  PRIMARY KEY (`recruit_school_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生学校' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_recruit_school
-- ----------------------------
INSERT INTO `e_r_recruit_school` VALUES (1281767950533042178, '招生学校', NULL, 1, '2020-07-11 09:51:08', NULL, NULL, NULL, NULL, 1);
INSERT INTO `e_r_recruit_school` VALUES (1281771392886415362, 'zp测试', NULL, 1, '2020-07-11 10:04:49', NULL, NULL, NULL, NULL, 201005);
...
CREATE TABLE `e_r_recruit_way`  (
  ...
  `student_public_relation_id` bigint(20) NULL DEFAULT NULL COMMENT '学生公关ID',
  `recruit_type` tinyint(4) NULL DEFAULT NULL COMMENT '渠道类型（0：线上，1：线下）',
  `online_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '线上渠道方式（0：网站招生，1：广告招生，2：朋友介绍）',
  `recommend_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '推荐人名称',
  `telephone` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系方式',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`recruit_way_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学生招生渠道表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_recruit_way
-- ----------------------------
INSERT INTO `e_r_recruit_way` VALUES (0, 1281777434508656641, 0, 'zptest', '', '', NULL, NULL, NULL);
...
CREATE TABLE `e_r_register_status_log`  (
  ...
  `student_public_relation_id` bigint(20) NULL DEFAULT NULL COMMENT '学生公关ID',
  `status_result` tinyint(4) NULL DEFAULT NULL COMMENT '状态结果（0：已交订金，1：已交全款，2：已退款，3：强意向生，4：已报名）',
  `modify_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `modify_id` bigint(20) NULL DEFAULT NULL COMMENT '修改人ID',
  `modify_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '修改人名称',
  PRIMARY KEY (`register_status_log_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '报名状态修改日志表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_register_status_log
-- ----------------------------
INSERT INTO `e_r_register_status_log` VALUES (1281869086636113921, 1281777434508656641, 1, '2020-07-11 16:33:01', 2238899772213054183, '王处长');
INSERT INTO `e_r_register_status_log` VALUES (1281869095255408642, 1281777434508656641, 2, '2020-07-11 16:33:03', 2238899772213054183, '王处长');
INSERT INTO `e_r_register_status_log` VALUES (1281869105430790145, 1281777434508656641, 1, '2020-07-11 16:33:05', 2238899772213054183, '王处长');
...
CREATE TABLE `e_r_request`  (
  ...
  `student_public_relation_id` bigint(20) NULL DEFAULT NULL COMMENT '学生公关ID',
  `request_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '诉求类型',
  `request_content` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '诉求内容',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `reply_id` bigint(20) NULL DEFAULT NULL COMMENT '回复人ID',
  `reply_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '回复人名称',
  `reply_time` datetime(0) NULL DEFAULT NULL COMMENT '回复时间',
  `reply_content` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '回复内容',
  `status` tinyint(4) NULL DEFAULT NULL COMMENT '诉求处理状态(0已处理，1未处理)',
  PRIMARY KEY (`request_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '诉求表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_request
-- ----------------------------
INSERT INTO `e_r_request` VALUES (1281837505141800961, 1281777434508656641, '专业诉求', '我的第一个诉求', '2020-07-11 14:27:31', 2238899772213054183, '王处长', '2020-07-11 16:50:11', '回复你', 0);
...
CREATE TABLE `e_r_score`  (
  ...
  `in_school_id` bigint(20) NULL DEFAULT NULL COMMENT '学生在校信息ID',
  `course` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '科目',
  `score` double NULL DEFAULT NULL COMMENT '成绩',
  PRIMARY KEY (`score_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '成绩表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_score
-- ----------------------------
INSERT INTO `e_r_score` VALUES (1281778044180103170, 1281778043479654401, '语文', 0);
INSERT INTO `e_r_score` VALUES (1281778044184297474, 1281778043479654401, '数学', 0);
INSERT INTO `e_r_score` VALUES (1281778044188491778, 1281778043479654401, '英语', 0);
...
CREATE TABLE `e_r_source_school`  (
  ...
  `recruit_school_id` bigint(20) NULL DEFAULT NULL COMMENT '招生学校ID',
  `source_school_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '生源学校名称',
  `province` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '所在省份',
  `city` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '所在城市',
  `district` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '所在区域',
  `is_relation` tinyint(4) NULL DEFAULT NULL COMMENT '是否公关（0：公关，1：不公关）',
  `relation_level` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '公关等级（1：重点公关 2：普通公关 3：重新公关）',
  `relation_type` tinyint(4) NULL DEFAULT NULL COMMENT '学校性质（0 公立，1 民营）',
  `source_scale` int(11) NULL DEFAULT NULL COMMENT '生源规模',
  `qualification` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学校资质',
  `address` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学校地址',
  `superior_dept` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '上级主管部门',
  `school_case_comment` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学校情况说明',
  `comment` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '说明',
  `recruit_amount` int(11) NULL DEFAULT NULL COMMENT '中招人数',
  `recruit_way` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '中招方式',
  `grade_director_name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '年级主任',
  `grade_director_tel` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '年级主任电话',
  `class_amount` int(11) NULL DEFAULT NULL COMMENT '班级数量',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `status` tinyint(4) NULL DEFAULT 1 COMMENT '状态（0：删除，1：正常）',
  `reserve` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '导入学校类型',
  PRIMARY KEY (`source_school_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '生源学校' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_source_school
-- ----------------------------
INSERT INTO `e_r_source_school` VALUES (1281766291291545601, 1281670615132041218, '武汉工程大学', '湖北省', '武汉市', '江夏区', NULL, NULL, 0, 9999, '一本', '流芳街道', '湖北省教育局', NULL, '这是一本', NULL, NULL, NULL, NULL, NULL, '2020-07-11 09:44:32', '王处长', 2238899772213054183, 0, '重点学校');
INSERT INTO `e_r_source_school` VALUES (1281766291291545602, 1281670615132041218, '武汉轻工大学', '湖北省', '武汉市', '东西湖区', NULL, NULL, 0, 99999, '一本', '金银潭', '湖北省教育局', NULL, '这是一本', NULL, NULL, NULL, NULL, NULL, '2020-07-11 09:44:32', '王处长', 2238899772213054183, 0, '跟进学校');
INSERT INTO `e_r_source_school` VALUES (1281766291291545603, 1281670615132041218, '华中科技大学', '湖北省', '武汉市', '武昌区', NULL, NULL, 1, 99999, '985', '珞珈街道', '湖北省教育局', NULL, '这是985', NULL, NULL, NULL, NULL, NULL, '2020-07-11 09:44:32', '王处长', 2238899772213054183, 0, '招生学校');
INSERT INTO `e_r_source_school` VALUES (1281768596661379073, 1281767950533042178, '武汉工程大学', '湖北省', '武汉市', '江夏区', NULL, NULL, 0, 9999, '一本', '流芳街道', '湖北省教育局', NULL, '这是一本', NULL, NULL, NULL, NULL, NULL, '2020-07-11 09:53:42', '刘雍星', -882429540250137944, 0, '重点学校');
INSERT INTO `e_r_source_school` VALUES (1281768596669767681, 1281767950533042178, '武汉轻工大学', '湖北省', '武汉市', '东西湖区', NULL, NULL, 0, 99999, '一本', '金银潭', '湖北省教育局', NULL, '这是一本', NULL, NULL, NULL, NULL, NULL, '2020-07-11 09:53:42', '刘雍星', -882429540250137944, 0, '跟进学校');
INSERT INTO `e_r_source_school` VALUES (1281768596669767682, 1281767950533042178, '华中科技大学', '湖北省', '武汉市', '武昌区', NULL, NULL, 1, 99999, '985', '珞珈街道', '湖北省教育局', NULL, '这是985', NULL, NULL, NULL, NULL, NULL, '2020-07-11 09:53:42', '刘雍星', -882429540250137944, 0, '招生学校');
INSERT INTO `e_r_source_school` VALUES (1281771651855327234, 1281771392886415362, '武汉工程大学', '湖北省', '武汉市', '江夏区', NULL, NULL, 0, 9999, '一本', '流芳街道', '湖北省教育局', NULL, '这是一本', NULL, NULL, NULL, NULL, NULL, '2020-07-11 10:05:51', '王处长', 2238899772213054183, 1, '重点学校');
INSERT INTO `e_r_source_school` VALUES (1281771651859521538, 1281771392886415362, '武汉轻工大学', '湖北省', '武汉市', '东西湖区', NULL, NULL, 0, 99999, '一本', '金银潭', '湖北省教育局', NULL, '这是一本', NULL, NULL, NULL, NULL, NULL, '2020-07-11 10:05:51', '王处长', 2238899772213054183, 1, '跟进学校');
INSERT INTO `e_r_source_school` VALUES (1281771651859521539, 1281771392886415362, '华中科技大学', '湖北省', '武汉市', '武昌区', NULL, NULL, 1, 99999, '985', '珞珈街道', '湖北省教育局', NULL, '这是985', NULL, NULL, NULL, NULL, NULL, '2020-07-11 10:05:51', '王处长', 2238899772213054183, 1, '招生学校');
INSERT INTO `e_r_source_school` VALUES (1281845349857665025, 1281771392886415362, '测试学校', '北京', '北京市', '西城区', NULL, '0', 0, 100, '功夫格斗', '符合该多好', '风格的韩国', '1235', '回复股东会非霍华德123', 9999, '宣讲,班主任指导,发宣传册', '45453', '13655555555', 1, '2020-07-11 14:58:42', '王处长', 2238899772213054183, 0, NULL);
INSERT INTO `e_r_source_school` VALUES (1281850986440204289, 1281767950533042178, '生源学校001', '福建省', '南平市', '仓山区', NULL, NULL, 0, 999, '一本', '999号', '教育局', NULL, '学校说明', NULL, NULL, NULL, NULL, NULL, '2020-07-11 15:21:05', '刘雍星', -882429540250137944, 1, NULL);
INSERT INTO `e_r_source_school` VALUES (1281851105264836610, 1281767950533042178, '生源学校002', '福建省', '南平市', '仓山区', NULL, NULL, 1, 1000, '211', '1000号', '教育局', NULL, '详细说明', NULL, NULL, NULL, NULL, NULL, '2020-07-11 15:21:34', '刘雍星', -882429540250137944, 1, NULL);
INSERT INTO `e_r_source_school` VALUES (1281851243878195201, 1281767950533042178, '生源学校003', '广西壮族自治区', '百色市', '良庆区', NULL, NULL, 0, 99856, '985', '9985号', '教育局', NULL, '说明', NULL, NULL, NULL, NULL, NULL, '2020-07-11 15:22:07', '刘雍星', -882429540250137944, 1, NULL);
...
CREATE TABLE `e_r_source_school_type`  (
  ...
  `source_school_id` bigint(20) NULL DEFAULT NULL COMMENT '生源学校ID',
  `type_id` bigint(20) NULL DEFAULT NULL COMMENT '数据字典ID',
  PRIMARY KEY (`source_school_type_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '生源学校类型' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_source_school_type
-- ----------------------------
INSERT INTO `e_r_source_school_type` VALUES (1281768598594953217, 1281768596661379073, 1281767950533042188);
INSERT INTO `e_r_source_school_type` VALUES (1281768598594953218, 1281768596669767681, 1281767950533042189);
INSERT INTO `e_r_source_school_type` VALUES (1281768598594953219, 1281768596669767682, 1281767950533042190);
INSERT INTO `e_r_source_school_type` VALUES (1281771653537243138, 1281771651855327234, 1281771392886415372);
INSERT INTO `e_r_source_school_type` VALUES (1281771653537243139, 1281771651859521538, 1281771392886415373);
INSERT INTO `e_r_source_school_type` VALUES (1281771653541437441, 1281771651859521539, 1281771392886415374);
INSERT INTO `e_r_source_school_type` VALUES (1281845476047495170, 1281845349857665025, 1281771392886415372);
INSERT INTO `e_r_source_school_type` VALUES (1281845476353679362, 1281845349857665025, 1281771392886415373);
INSERT INTO `e_r_source_school_type` VALUES (1281845476659863554, 1281845349857665025, 1281771392886415374);
INSERT INTO `e_r_source_school_type` VALUES (1281850986758971394, 1281850986440204289, 1281767950533042188);
INSERT INTO `e_r_source_school_type` VALUES (1281851105600380930, 1281851105264836610, 1281767950533042189);
INSERT INTO `e_r_source_school_type` VALUES (1281851244213739521, 1281851243878195201, 1281767950533042190);
...
CREATE TABLE `e_r_student_info`  (
  ...
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `gender` tinyint(4) NULL DEFAULT NULL COMMENT '性别（0：男，1：女）',
  `image_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '照片url',
  `nation` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '民族',
  `doa` date NULL DEFAULT NULL COMMENT '出生年月',
  `id_no` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '身份证号',
  `health_status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '身体状况',
  `province` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '户籍省份',
  `city` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '户籍城市',
  `district` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '户籍区域',
  `wechat` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学生微信',
  `parent_telephone` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '家长联系方式',
  `student_telephone` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学生联系方式',
  `family_province` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '家庭省份',
  `family_city` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '家庭城市',
  `family_district` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '家庭区域',
  `address` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '详细地址',
  `qq_no` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'qq号',
  PRIMARY KEY (`student_info`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学生基本信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_student_info
-- ----------------------------
INSERT INTO `e_r_student_info` VALUES (1281777433648824322, '郑平', '2020-07-11 10:28:49', NULL, 2238899772213054183, 0, '8a1bc7dc-7fd8-4016-9bcb-cfe2579d1cfaIMG_20191025_174243.jpg', '傈僳族', '1990-01-01', '421125199001012222', '健康', '福建省', '福州市', '鼓楼区', 'ZZ22xR', '13294159015', '13866662424', '甘肃省', '兰州市', '皋兰县', '32号', NULL);
INSERT INTO `e_r_student_info` VALUES (1282936527277039617, '你那的卡', '2020-07-14 15:14:39', NULL, NULL, 0, NULL, '汉族', '1990-01-01', '421023199502020232', '健康', '北京', '北京市', '东城区', NULL, '13534261840', NULL, '北京', '北京市', '东城区', '详细家庭地址', NULL);
...
CREATE TABLE `e_r_student_public_relation`  (
  ...
  `reason` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '意向原因',
  `direction` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '公关方向',
  `relation_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '跟进类型',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '负责人',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '负责人名称',
  `register_status` tinyint(4) NULL DEFAULT 3 COMMENT '报名状态（0：已交订金，1：已交全款，2：已退款，3：强意向生，4：已报名）',
  `semester` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '学期',
  `group_id` bigint(20) NULL DEFAULT NULL COMMENT '招生组ID',
  `semester_id` bigint(20) NULL DEFAULT NULL COMMENT '学期ID',
  `student_no` int(11) NULL DEFAULT 1 COMMENT '登记编号',
  `status_change_time` date NULL DEFAULT NULL COMMENT '状态改变时间',
  PRIMARY KEY (`student_public_relation_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学生公关表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_student_public_relation
-- ----------------------------
INSERT INTO `e_r_student_public_relation` VALUES (1281777434508656641, 1281777433648824322, 1281771392886415362, 1281771651855327234, 1281874401825914882, '2020-07-11 10:28:49', 1, NULL, NULL, NULL, NULL, 2238899772213054183, NULL, 1, NULL, 1281771918109745154, 6959578747970340926, 1, '2020-07-11');
INSERT INTO `e_r_student_public_relation` VALUES (1282936527792939010, 1282936527277039617, 1281771392886415362, 1281771651859521539, 1282936217284395010, '2020-07-14 15:14:39', 1, NULL, NULL, NULL, NULL, 3745520413114911150, NULL, 3, NULL, 1281870701002792961, 4478489728732514178, 1, NULL);
...
CREATE TABLE `e_r_sys_dictionary`  (
  ...
  `data_code` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '数据编码',
  `data_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '数据类型（1：文本，2：布尔值，3：数值，4：日期）',
  `data_value` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '数据名称/数据值',
  `data_english_value` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '数据英文名称',
  `data_desc` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '数据说明',
  `data_order` int(11) NULL DEFAULT NULL COMMENT '数据顺序',
  `is_read_only` tinyint(4) NULL DEFAULT 0 COMMENT '是否只读（0：否，1：只读）',
  `is_deleted` tinyint(4) NULL DEFAULT 0 COMMENT '状态（0：正常，1：删除）',
  `modify_id` bigint(20) NULL DEFAULT NULL COMMENT '最后修改人',
  `modify_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '修改人名称',
  `modify_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `recruit_school_id` bigint(20) NULL DEFAULT NULL COMMENT '招生学校ID',
  PRIMARY KEY (`dictionary_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '系统数字字典' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_sys_dictionary
-- ----------------------------
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042179, 0, 'online_target', '1', '线上招生目标', 'online_target', '线上招生目标', 1, 0, 0, 1, 'admin', '2020-04-15 12:24:28', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042180, 1281767950533042179, 'web', '1', '网站招生', 'web', '网站招生', 1, 0, 0, 1, 'admin', '2020-04-15 12:25:08', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042181, 1281767950533042179, 'ads', '1', '广告招生', 'ads', '广告招生', 2, 0, 0, 1, 'admin', '2020-04-15 12:25:08', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042182, 1281767950533042179, 'friend', '1', '朋友介绍', 'friend', '朋友介绍', 3, 0, 0, 1, 'admin', '2020-04-15 12:25:08', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042183, 0, 'recruit_zone', '1', '招生区域', 'recruit_zone', '招生区域', 1, 1, 0, 1, 'admin', '2020-04-16 13:45:31', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042184, 1281767950533042183, 'east_zone', '1', '东部', 'east_zone', '东部', 1, 0, 0, 1, 'admin', '2020-04-16 13:45:34', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042185, 1281767950533042183, 'west_zone', '1', '西部', 'west_zone', '西部', 2, 0, 0, 1, 'admin', '2020-04-16 13:45:36', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042186, 1281767950533042183, 'mid_zone', '1', '中部', 'mid_zone', '中部', 3, 0, 0, 1, 'admin', '2020-04-16 13:45:39', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042187, 0, 'school_tag', '1', '学校标签', 'school_tag', '学校标签', 1, 1, 0, 1, 'admin', '2020-04-16 13:46:26', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042188, 1281767950533042187, 'head_school', '1', '重点学校', 'head_school', '重点学校', 1, 0, 0, 1, 'admin', '2020-04-16 13:47:07', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042189, 1281767950533042187, 'public_school', '1', '跟进学校', 'public_school', '公关学校', 2, 0, 0, 1, 'admin', '2020-04-16 13:47:42', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042190, 1281767950533042187, 'recruit_school', '1', '招生学校', 'recruit_school', '招生学校', 3, 0, 0, 1, 'admin', '2020-04-16 13:48:23', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042191, 0, 'news_message_type', '1', '新闻信息类型', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042192, 1281767950533042191, 'school_info', '1', '学校信息', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042193, 1281767950533042191, 'major_info', '1', '专业信息', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042194, 0, 'task_type', '1', '任务类型', 'task_type', '任务类型', 1, 1, 0, NULL, NULL, NULL, 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042195, 1281767950533042194, 'maintain_school', '1', '计划发布，维护学校信息', 'maintain_school', '维护学校信息', 1, 0, 0, NULL, NULL, NULL, 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042196, 1281767950533042194, 'maintain_preach', '1', '计划发布，维护宣讲计划', 'maintain_preach', '维护宣讲计划', 1, 0, 0, NULL, NULL, NULL, 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042197, 1281767950533042194, 'preach_schdule', '1', '明天有宣讲任务', 'preach_schdule', '宣讲任务', 1, 0, 0, NULL, NULL, NULL, 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042198, 1281767950533042194, 'request_deal', '1', '有新的诉求请处理', 'request_deal', '诉求处理', 1, 0, 0, NULL, NULL, NULL, 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042199, 1281767950533042194, 'consultation_deal', '1', '有新的到校咨询请处理', 'consultation_deal', '到校咨询处理', 1, 0, 0, NULL, NULL, NULL, 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281767950533042200, 1281767950533042194, 'admission', '1', '亲爱的{0}同学： 经学校招生委员会审查合格，同意你报读我校{1}科班{2}专业。请确认到校就读，并于2020年8月29日。按《入学须知》到校报到注册。', 'admission', '入学通知', 1, 1, 0, NULL, '', '2020-05-20 17:35:58', 1281767950533042178);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415363, 0, 'online_target', '1', '线上招生目标', 'online_target', '线上招生目标', 1, 0, 0, 1, 'admin', '2020-04-15 12:24:28', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415364, 1281771392886415363, 'web', '1', '网站招生', 'web', '网站招生', 1, 0, 0, 1, 'admin', '2020-04-15 12:25:08', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415365, 1281771392886415363, 'ads', '1', '广告招生', 'ads', '广告招生', 2, 0, 0, 1, 'admin', '2020-04-15 12:25:08', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415366, 1281771392886415363, 'friend', '1', '朋友介绍', 'friend', '朋友介绍', 3, 0, 0, 1, 'admin', '2020-04-15 12:25:08', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415367, 0, 'recruit_zone', '1', '招生区域', 'recruit_zone', '招生区域', 1, 1, 0, 1, 'admin', '2020-04-16 13:45:31', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415368, 1281771392886415367, 'east_zone', '1', '东部', 'east_zone', '东部', 1, 0, 0, 1, 'admin', '2020-04-16 13:45:34', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415369, 1281771392886415367, 'west_zone', '1', '西部', 'west_zone', '西部', 2, 0, 0, 1, 'admin', '2020-04-16 13:45:36', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415370, 1281771392886415367, 'mid_zone', '1', '中部', 'mid_zone', '中部', 3, 0, 0, 1, 'admin', '2020-04-16 13:45:39', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415371, 0, 'school_tag', '1', '学校标签', 'school_tag', '学校标签', 1, 1, 0, 1, 'admin', '2020-04-16 13:46:26', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415372, 1281771392886415371, 'head_school', '1', '重点学校', 'head_school', '重点学校', 1, 0, 0, 1, 'admin', '2020-04-16 13:47:07', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415373, 1281771392886415371, 'public_school', '1', '跟进学校', 'public_school', '公关学校', 2, 0, 0, 1, 'admin', '2020-04-16 13:47:42', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415374, 1281771392886415371, 'recruit_school', '1', '招生学校', 'recruit_school', '招生学校', 3, 0, 0, 1, 'admin', '2020-04-16 13:48:23', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415375, 0, 'news_message_type', '1', '新闻信息类型', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415376, 1281771392886415375, 'school_info', '1', '学校信息', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415377, 1281771392886415375, 'major_info', '1', '专业信息', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415378, 0, 'task_type', '1', '任务类型', 'task_type', '任务类型', 1, 1, 0, NULL, NULL, NULL, 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415379, 1281771392886415378, 'maintain_school', '1', '计划发布，维护学校信息', 'maintain_school', '维护学校信息', 1, 0, 0, NULL, NULL, NULL, 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415380, 1281771392886415378, 'maintain_preach', '1', '计划发布，维护宣讲计划', 'maintain_preach', '维护宣讲计划', 1, 0, 0, NULL, NULL, NULL, 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415381, 1281771392886415378, 'preach_schdule', '1', '明天有宣讲任务', 'preach_schdule', '宣讲任务', 1, 0, 0, NULL, NULL, NULL, 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415382, 1281771392886415378, 'request_deal', '1', '有新的诉求请处理', 'request_deal', '诉求处理', 1, 0, 0, NULL, NULL, NULL, 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415383, 1281771392886415378, 'consultation_deal', '1', '有新的到校咨询请处理', 'consultation_deal', '到校咨询处理', 1, 0, 0, NULL, NULL, NULL, 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771392886415384, 1281771392886415378, 'admission', '1', '亲爱的{0}同学： 经学校招生委员会审查合格大丰收规范的很舒服的的合同任何人好疼规范的格式个人为个人风格和任亲爱的{0}同学： 经学校招生委员会审查合格大丰收规范的很舒服的的合同任何人好疼规范的格式个人为个人风格和任何今日推荐任何方式呢，同意你报读我校{1}科班{2}专业。请确认到校就读，并于2020年8月29日。按《入学须知》到校报到注册                                                                                                                                     方大化工鹤顶红孤鸿寡鹄非的故事读后感好好干IG会死的更好的更好地变得更好的时候滴hire化工复合大师共和国规划法大使馆和计划开发接口根据科技控股交电话费is方大化工害死人韩国为OK回复的规划日后日哦更快更好佛韩国为on丰富的感受更大的好舒服供货方暖风电机高速口哦哦呢光伏欧弟和死哦喝咖啡你赶快开公司复合大师hi他人hi噢红色【【【【【【【【【【【【【【【【【【规范的数据库反馈还是客户端看开个房东收工会送的可能是空格防控的恢复高考给你看看吧代购韩国好看的烦恼分开发动机哪个福建省大类国际国家队的价格的结果是呱唧呱唧艘大公鸡哦给对方就是个激动奇偶大家都搜狗简介哦干净点何今日推荐任何方式呢，同意你报读我校{1}科班{2}专业。请确认到校就读，并于2020年8月29日。按《入学须知》到校报到注册                                                                                                                                     方大化工鹤顶红孤鸿寡鹄非的故事读后感好好干IG会死的更好的更好地变得更好的时候滴hire化工复合大师共和国规划法大使馆和计划开发接口根据科技控股交电话费is方大化工害死人韩国为OK回复的规划日后日哦更快更好佛韩国为on丰富的感受更大的好舒服供货方暖风电机高速口哦哦呢光伏欧弟和死哦喝咖啡你赶快开公司复合大师hi他人hi噢红色【【【【【【【【【【【【【【【【【【规范的数据库反馈还是客户端看开个房东收工会送的可能是空格防控的恢复高考给你看看吧代购韩国好看的烦恼分开发动机哪个福建省大类国际国家队的价格的结果是呱唧呱唧艘大公鸡哦给对方就是个激动奇偶大家都搜狗简介哦干净点', 'admission', '入学通知', 1, 1, 0, 2238899772213054183, '王处长', '2020-07-11 16:36:32', 1281771392886415362);
INSERT INTO `e_r_sys_dictionary` VALUES (1281771589385363458, 1281771392886415363, 'zptest', '1', 'zptest', 'zptest', '', 0, 0, 0, 2238899772213054183, '王处长', '2020-07-11 10:05:36', 1281771392886415362);

-- ----------------------------
-- Table structure for e_r_sys_dictionary_copy
-- ----------------------------
DROP TABLE IF EXISTS `e_r_sys_dictionary_copy`;
CREATE TABLE `e_r_sys_dictionary_copy`  (
  `dictionary_id` bigint(20) NOT NULL COMMENT '数字字典id',
  `parent_id` bigint(20) NULL DEFAULT NULL COMMENT '父id',
  `data_code` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '数据编码',
  `data_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '数据类型（1：文本，2：布尔值，3：数值，4：日期）',
...
-- ----------------------------
-- Records of e_r_sys_dictionary_copy
-- ----------------------------
INSERT INTO `e_r_sys_dictionary_copy` VALUES (1, 0, 'online_target', '1', '线上招生目标', 'online_target', '线上招生目标', 1, 0, 0, 1, 'admin', '2020-04-15 12:24:28', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (2, 1, 'web', '1', '网站招生', 'web', '网站招生', 1, 0, 0, 1, 'admin', '2020-04-15 12:25:08', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (3, 1, 'ads', '1', '广告招生', 'ads', '广告招生', 2, 0, 0, 1, 'admin', '2020-04-15 12:25:08', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (4, 1, 'friend', '1', '朋友介绍', 'friend', '朋友介绍', 3, 0, 0, 1, 'admin', '2020-04-15 12:25:08', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (5, 0, 'recruit_zone', '1', '招生区域', 'recruit_zone', '招生区域', 1, 1, 0, 1, 'admin', '2020-04-16 13:45:31', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (6, 5, 'east_zone', '1', '东部', 'east_zone', '东部', 1, 0, 0, 1, 'admin', '2020-04-16 13:45:34', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (7, 5, 'west_zone', '1', '西部', 'west_zone', '西部', 2, 0, 0, 1, 'admin', '2020-04-16 13:45:36', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (8, 5, 'mid_zone', '1', '中部', 'mid_zone', '中部', 3, 0, 0, 1, 'admin', '2020-04-16 13:45:39', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (9, 0, 'school_tag', '1', '学校标签', 'school_tag', '学校标签', 1, 1, 0, 1, 'admin', '2020-04-16 13:46:26', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (10, 9, 'head_school', '1', '重点学校', 'head_school', '重点学校', 1, 0, 0, 1, 'admin', '2020-04-16 13:47:07', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (11, 9, 'public_school', '1', '跟进学校', 'public_school', '公关学校', 2, 0, 0, 1, 'admin', '2020-04-16 13:47:42', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (12, 9, 'recruit_school', '1', '招生学校', 'recruit_school', '招生学校', 3, 0, 0, 1, 'admin', '2020-04-16 13:48:23', 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (13, 0, 'news_message_type', '1', '新闻信息类型', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (14, 13, 'school_info', '1', '学校信息', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (15, 13, 'major_info', '1', '专业信息', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (16, 0, 'task_type', '1', '任务类型', 'task_type', '任务类型', 1, 1, 0, NULL, NULL, NULL, 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (17, 16, 'maintain_school', '1', '计划发布，维护学校信息', 'maintain_school', '维护学校信息', 1, 0, 0, NULL, NULL, NULL, 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (18, 16, 'maintain_preach', '1', '计划发布，维护宣讲计划', 'maintain_preach', '维护宣讲计划', 1, 0, 0, NULL, NULL, NULL, 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (19, 16, 'preach_schdule', '1', '明天有宣讲任务', 'preach_schdule', '宣讲任务', 1, 0, 0, NULL, NULL, NULL, 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (20, 16, 'request_deal', '1', '有新的诉求请处理', 'request_deal', '诉求处理', 1, 0, 0, NULL, NULL, NULL, 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (21, 16, 'consultation_deal', '1', '有新的到校咨询请处理', 'consultation_deal', '到校咨询处理', 1, 0, 0, NULL, NULL, NULL, 1252559728180355074);
INSERT INTO `e_r_sys_dictionary_copy` VALUES (22, 16, 'admission', '1', '亲爱的{0}同学： 经学校招生委员会审查合格，同意你报读我校{1}科班{2}专业。请确认到校就读，并于2020年8月29日。按《入学须知》到校报到注册。', 'admission', '入学通知', 1, 1, 0, NULL, '', '2020-05-20 17:35:58', 1252559728180355074);
...
CREATE TABLE `e_r_sys_nation`  (
  `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '民族ID',
  `nation` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '民族',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统民族表' ROW_FORMAT = Compact;
...
CREATE TABLE `e_r_sys_region`  (
  ...
  `parent_id` bigint(20) NULL DEFAULT NULL COMMENT '父ID',
  `short_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '简称',
  `name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '名称',
  `merger_name` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '全称',
  `level` tinyint(4) NULL DEFAULT NULL COMMENT '层级（1：省，2：市，3：区县）',
  `pinyin` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '拼音',
  `code` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '长途区号',
  `zip_code` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮编',
  PRIMARY KEY (`region_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统地区表' ROW_FORMAT = Compact;
...
CREATE TABLE `e_r_target`  (
  ...
  `title` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '标题',
  `target_amount` int(11) NULL DEFAULT NULL COMMENT '目标数量',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `creator_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
  `modify_id` bigint(20) NULL DEFAULT NULL COMMENT '最后修改人',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '目标' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_target
-- ----------------------------
INSERT INTO `e_r_target` VALUES (1281770057478742018, '湖南大学2041年招生', '废弃--勿用', 1000, '2020-07-11 09:59:30', '刘雍星', -882429540250137944, -882429540250137944, '刘雍星', '2020-07-11 15:25:30', -5892329399024400876, 1281767950533042178);
INSERT INTO `e_r_target` VALUES (1281771821917577218, '招生计划--上学期', '招生目标--上学期', 700, '2020-07-11 10:06:31', '王处长', 2238899772213054183, NULL, NULL, NULL, 6959578747970340926, 1281771392886415362);
INSERT INTO `e_r_target` VALUES (1281852416874029057, '北京大学上学期', '招生目标--北京大学上学期', 700, '2020-07-11 15:26:47', '刘雍星', -882429540250137944, NULL, NULL, NULL, 7201704839644991172, 1281767950533042178);
INSERT INTO `e_r_target` VALUES (1281870971610898434, '招生计划--下学期', '招生目标--下学期', 600, '2020-07-11 16:40:30', '王处长', 2238899772213054183, NULL, NULL, NULL, 4478489728732514178, 1281771392886415362);
...
CREATE TABLE `e_r_target_decomposition`  (
  `target_decomposition_id` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '目标分解ID',
  `target_id` bigint(20) NULL DEFAULT NULL COMMENT '目标ID',
  `parent_id` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '父节点ID',
  `type` tinyint(4) NULL DEFAULT NULL COMMENT '类型（0：渠道，1：专业）',
  `node_id` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '节点ID（平台接口ID）',
  `node_name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '节点名称',
  `target_amount` int(11) NULL DEFAULT NULL COMMENT '目标数量',
  `comment` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '说明',
  PRIMARY KEY (`target_decomposition_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生目标分解(树形表) ' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_target_decomposition
-- ----------------------------
INSERT INTO `e_r_target_decomposition` VALUES ('033ee0b7-cd7a-47ef-8ca0-197a68a5cb23', 1281771821917577218, '375557d8-ff5c-4cc0-a869-7bef813df6c8', 0, NULL, 'zptest', 20, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('07a85506-4d13-420d-8ecf-12e1886fd688', 1281870971610898434, '0', 0, NULL, '线上招生目标', 200, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('09441434-93b5-4949-b8ea-957ce3d9d874', 1281771821917577218, 'e6583d5d-07d2-482a-9c6e-22acf34345ed', 0, '1281771918109745154', '王处长的小组', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('0aba7162-cb9e-461c-8d92-0e0721e11a1f', 1281770057478742018, 'e5ee6c5d-83f4-4b5f-b9e9-f5a893447dd0', 1, '778536754874894074', '新增专业测试3', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('0bd27733-21b5-4459-906e-f65dbed8c28a', 1281852416874029057, '2a72ba00-4f9f-43bf-bf39-12637667b92b', 1, '2453292565540589314', '测试招生专业01', 100, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('0bebe002-ca6e-402b-a587-13724cd30ffe', 1281870971610898434, '8adea6fe-8c29-49e6-899a-6358801c0ddc', 1, '-7581490097643175749', 'zp_J文综学院专业', 200, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('12785356-f54b-4274-a6c5-4b4af4b8674c', 1281771821917577218, '4d8a8239-eb36-420c-89aa-fe09b34b957e', 1, '7281651321522835354', 'zp_招生专业1', 100, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('203c58e8-71cd-409d-9e94-29559b028a61', 1281870971610898434, 'fc23170a-439c-4689-bc6e-400e882faaa2', 0, '1281870701002792961', '郭处长的小组', 150, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('293001d2-f409-48a3-8bed-cba9fe4a30e3', 1281870971610898434, 'd17c65b2-6c22-452c-b84f-4ea10730416a', 1, '-7082136505393985028', 'zp_基础学院专业', 50, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('2a72ba00-4f9f-43bf-bf39-12637667b92b', 1281852416874029057, '0', 1, '-473512388439879874', '信息技术', 100, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('306ab993-a4ee-4242-85d2-35a766c45fb4', 1281770057478742018, '0', 1, '-473512388439879874', '信息技术', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('361082d1-37e3-43cf-bcce-a3bd490168ae', 1281771821917577218, '0', 1, '-4707823322812559367', '招生', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('375557d8-ff5c-4cc0-a869-7bef813df6c8', 1281771821917577218, '0', 0, NULL, '线上招生目标', 400, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('46ec7e71-f281-4a39-a00d-309f2063a12a', 1281852416874029057, 'f941e49a-85d6-47c3-926e-90f943123ff6', 0, '1281853853884522497', '第二小组', 150, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('48946b46-4404-4c97-a529-bed390887bd0', 1281870971610898434, '0', 1, '-824708636807314491', '测试', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('4d8a8239-eb36-420c-89aa-fe09b34b957e', 1281771821917577218, '0', 1, '-5552494227726187922', 'Java', 200, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('5600cdb6-c56c-4c83-a62d-2279e344e826', 1281770057478742018, 'e6120c8e-a8dd-47fb-abd9-f4b3c7d00144', 1, '236863209421099687', 'UI', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('591b1c87-3bce-4c93-9455-43fe0395590c', 1281870971610898434, '07a85506-4d13-420d-8ecf-12e1886fd688', 0, NULL, '网站招生', 50, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('5e2a1db6-4ab7-4836-bce1-c90babbe8036', 1281870971610898434, '0', 1, '-5552494227726187922', 'Java', 200, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('5f8be7d5-7f88-40fa-85e5-805b19c50b3f', 1281870971610898434, '5e2a1db6-4ab7-4836-bce1-c90babbe8036', 1, '1102334001898144998', 'zp_JAVA学院专业', 100, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('626a6c2f-fe3c-4cd5-b960-aa114d69d3cf', 1281771821917577218, 'f2a479e1-aa64-467d-a224-92bff71ec332', 1, '-7581490097643175749', 'zp_J文综学院专业', 100, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('65ac6572-5d3e-4512-8795-cc4feba02a5a', 1281771821917577218, '375557d8-ff5c-4cc0-a869-7bef813df6c8', 0, NULL, '朋友介绍', 140, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('67c3e511-648a-46e9-976c-3c175c973ffe', 1281852416874029057, 'e30bf705-c771-4c77-9da4-3a2d2aca6ab7', 0, NULL, '广告招生', 70, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('6bd9adac-dc9b-412d-8d54-4a01c47c07f3', 1281770057478742018, 'e6120c8e-a8dd-47fb-abd9-f4b3c7d00144', 1, '4440389377537296143', '????1', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('6c67237c-0b8b-4bc2-b9a2-6c7e5ac9e84a', 1281770057478742018, '0', 0, NULL, '线上招生目标', 700, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('6cab49f9-aef6-41dd-b83a-bc69517681e6', 1281870971610898434, 'fc23170a-439c-4689-bc6e-400e882faaa2', 0, '1281870698901446658', '王处长的小组', 250, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('7724b130-b723-453d-add5-e65268b9a5d0', 1281770057478742018, '6c67237c-0b8b-4bc2-b9a2-6c7e5ac9e84a', 0, NULL, '网站招生', 200, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('77c2511b-0fad-49b8-828d-be7f2858cc6c', 1281771821917577218, '0', 1, '-824708636807314491', '测试', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('7d2d05b8-7685-4112-b92f-596674c18026', 1281870971610898434, '0', 1, '-4707823322812559367', '招生', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('7f01511c-9bfc-48a3-b645-54e914b86526', 1281770057478742018, 'e6120c8e-a8dd-47fb-abd9-f4b3c7d00144', 1, '787633608434663800', '????1', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('7f6bf53d-3a75-4abb-9449-5ffc3307bfe1', 1281852416874029057, 'febf9d0a-350d-41cc-9b7c-2c8b7d3648a5', 1, '778536754874894074', '新增专业测试3', 100, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('81e54ca5-a64a-4563-b4e2-cfdb2f084280', 1281770057478742018, '6c67237c-0b8b-4bc2-b9a2-6c7e5ac9e84a', 0, NULL, '广告招生', 160, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('8981a187-ac64-4ea1-943c-f850bd4028b6', 1281870971610898434, 'd8a487e1-f411-4d12-97f1-a38b48f86aa7', 1, '-4437318172019506131', 'zp_J理综学院专业', 150, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('8adea6fe-8c29-49e6-899a-6358801c0ddc', 1281870971610898434, '0', 1, '-2578475429000756138', '文综', 200, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('8b9f2238-3190-4fda-a452-8b653f347829', 1281852416874029057, 'e30bf705-c771-4c77-9da4-3a2d2aca6ab7', 0, NULL, '网站招生', 70, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('8d972090-9656-4a71-992e-1188de96cea7', 1281852416874029057, 'f941e49a-85d6-47c3-926e-90f943123ff6', 0, '1281853808753811457', '第一小组', 350, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('91bb88be-12a2-4827-bf19-e7e663df6ebb', 1281852416874029057, 'ed32d3ed-82f5-4654-9808-4ca11ecd3e99', 1, '3451632112113829933', '测试专业1', 10, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('9351bcd9-68f7-47a6-afde-1082ab382194', 1281852416874029057, 'ed32d3ed-82f5-4654-9808-4ca11ecd3e99', 1, '4052878438551866947', '测试专业2', 20, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('963fc7fc-76e9-4410-9e02-dfcd341e0195', 1281771821917577218, '0', 1, '1953118350262554094', '基础', 150, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('96ef6afe-fc71-4e4b-9a8f-530be28bb8ad', 1281852416874029057, '0', 1, '2004803501152027269', '机电商贸', 300, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('970130cb-36a8-4f01-a3ab-2ef5f3272272', 1281770057478742018, '0', 1, '2004803501152027269', '机电商贸', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('9b250811-7a45-43ae-93ca-4c010adb8ba2', 1281771821917577218, '375557d8-ff5c-4cc0-a869-7bef813df6c8', 0, NULL, '网站招生', 140, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('9cfa090d-335c-4ba2-b746-769e4211dcc3', 1281852416874029057, 'ed32d3ed-82f5-4654-9808-4ca11ecd3e99', 1, '787633608434663800', '????1', 30, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('a348cf71-9d12-46b6-8904-2a1b657ed5db', 1281852416874029057, 'ed32d3ed-82f5-4654-9808-4ca11ecd3e99', 1, '4440389377537296143', '????1', 40, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('a368ce3f-0603-42db-9bd7-b43e3704fdaf', 1281770057478742018, '0', 0, NULL, '线下招生目标', 300, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('a439f435-3823-48b9-a68a-a129832d9533', 1281771821917577218, '375557d8-ff5c-4cc0-a869-7bef813df6c8', 0, NULL, '广告招生', 100, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('b0722752-e814-4891-8a31-8747415c9e16', 1281771821917577218, '4d8a8239-eb36-420c-89aa-fe09b34b957e', 1, '1102334001898144998', 'zp_JAVA学院专业', 100, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('bc94bdc2-88f1-4aca-8bfd-77d083c8fbba', 1281770057478742018, '6c67237c-0b8b-4bc2-b9a2-6c7e5ac9e84a', 0, NULL, '朋友介绍', 340, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('bec9be1f-c0b0-4cdb-9490-f236227a6eff', 1281852416874029057, 'ed32d3ed-82f5-4654-9808-4ca11ecd3e99', 1, '236863209421099687', 'UI', 100, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('c30cb134-4c19-440b-9b82-f09737be9280', 1281771821917577218, '963fc7fc-76e9-4410-9e02-dfcd341e0195', 1, '-7082136505393985028', 'zp_基础学院专业', 150, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('ce24c0df-2a7e-49e1-a518-7b89a2c5e039', 1281770057478742018, 'e6120c8e-a8dd-47fb-abd9-f4b3c7d00144', 1, '3451632112113829933', '测试专业1', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('d17c65b2-6c22-452c-b84f-4ea10730416a', 1281870971610898434, '0', 1, '1953118350262554094', '基础', 50, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('d7c16df2-cb81-4eed-ba10-dc42c39a5b84', 1281770057478742018, '306ab993-a4ee-4242-85d2-35a766c45fb4', 1, '2453292565540589314', '测试招生专业01', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('d8a487e1-f411-4d12-97f1-a38b48f86aa7', 1281870971610898434, '0', 1, '593214709207353276', '理综', 150, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('d8e09604-d235-43c1-b9d7-1323d82db059', 1281870971610898434, '07a85506-4d13-420d-8ecf-12e1886fd688', 0, NULL, 'zptest', 50, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('ddafefbd-2bae-41d7-980e-a5b173d04354', 1281771821917577218, 'e5baa322-fe5e-4122-92ca-9088176e6954', 1, '-4437318172019506131', 'zp_J理综学院专业', 250, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('dfa5437d-bb09-47c6-9352-13a543d0a479', 1281771821917577218, 'e6583d5d-07d2-482a-9c6e-22acf34345ed', 0, '1281771973537472513', '郭处长的小组', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('e227abb5-4c42-42c3-acb3-eb849c465a44', 1281770057478742018, 'e6120c8e-a8dd-47fb-abd9-f4b3c7d00144', 1, '4052878438551866947', '测试专业2', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('e30bf705-c771-4c77-9da4-3a2d2aca6ab7', 1281852416874029057, '0', 0, NULL, '线上招生目标', 200, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('e5baa322-fe5e-4122-92ca-9088176e6954', 1281771821917577218, '0', 1, '593214709207353276', '理综', 250, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('e5ee6c5d-83f4-4b5f-b9e9-f5a893447dd0', 1281770057478742018, '0', 1, '-4055519447386534861', '高考', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('e6120c8e-a8dd-47fb-abd9-f4b3c7d00144', 1281770057478742018, '0', 1, '-2812866589434164485', '艺术特长', 0, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('e6583d5d-07d2-482a-9c6e-22acf34345ed', 1281771821917577218, '0', 0, NULL, '线下招生目标', 300, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('ed32d3ed-82f5-4654-9808-4ca11ecd3e99', 1281852416874029057, '0', 1, '-2812866589434164485', '艺术特长', 200, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('efa832ca-18cb-4dc4-a8e9-b1f8dc84d9f6', 1281870971610898434, '07a85506-4d13-420d-8ecf-12e1886fd688', 0, NULL, '朋友介绍', 50, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('f2a479e1-aa64-467d-a224-92bff71ec332', 1281771821917577218, '0', 1, '-2578475429000756138', '文综', 100, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('f2e0cb00-587f-48f4-a6a3-848e59a800f2', 1281870971610898434, '5e2a1db6-4ab7-4836-bce1-c90babbe8036', 1, '7281651321522835354', 'zp_招生专业1', 100, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('f82d4a43-2b91-452e-b6d6-7c2d40a6a845', 1281870971610898434, '07a85506-4d13-420d-8ecf-12e1886fd688', 0, NULL, '广告招生', 50, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('f941e49a-85d6-47c3-926e-90f943123ff6', 1281852416874029057, '0', 0, NULL, '线下招生目标', 500, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('faad5aa6-18de-48f1-8454-23801bb7c1bc', 1281852416874029057, 'e30bf705-c771-4c77-9da4-3a2d2aca6ab7', 0, NULL, '朋友介绍', 60, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('fc23170a-439c-4689-bc6e-400e882faaa2', 1281870971610898434, '0', 0, NULL, '线下招生目标', 400, NULL);
INSERT INTO `e_r_target_decomposition` VALUES ('febf9d0a-350d-41cc-9b7c-2c8b7d3648a5', 1281852416874029057, '0', 1, '-4055519447386534861', '高考', 100, NULL);
...
CREATE TABLE `e_r_task`  (
  ...
  `status` tinyint(4) NULL DEFAULT 0 COMMENT '状态（0：未完成，1：完成）',
  `title` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '标题',
  `content` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '内容',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `task_type` tinyint(4) NULL DEFAULT NULL COMMENT '类型（0：维护学校，1：维护宣讲，2：宣讲任务，3：诉求，4：咨询，5：入学通知）',
  `jump_page` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '跳转页面',
  `semester_id` bigint(20) NULL DEFAULT NULL COMMENT '学期ID',
  `related_id` bigint(20) NULL DEFAULT NULL COMMENT '相关ID',
  `report_type` tinyint(4) NULL DEFAULT NULL COMMENT '上报方式（0：系统上报，1：用户填报）',
  `creator_id` bigint(20) NULL DEFAULT NULL COMMENT '发布人员ID',
  `creator_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '发布人员名称',
  `type` tinyint(4) NULL DEFAULT 0 COMMENT '类型（0：任务，1：学生信息）',
  PRIMARY KEY (`task_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招生任务表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_task
-- ----------------------------
INSERT INTO `e_r_task` VALUES (1281774214977724417, 0, NULL, 'maintain_school', '2020-07-11 10:16:02', 0, '/sourceSchool/listCompleteRate', 6959578747970340926, NULL, 0, NULL, NULL, 0);
INSERT INTO `e_r_task` VALUES (1281774215309074434, 0, NULL, 'maintain_preach', '2020-07-11 10:16:02', 1, '/preach-plan/pageAllPreachPlanByUserId', 6959578747970340926, NULL, 0, NULL, NULL, 0);
INSERT INTO `e_r_task` VALUES (1281837505976467458, 1, NULL, 'request_deal', '2020-07-11 14:27:31', 3, '/request/queryRequestInfoByRecruitSchoolId', 6959578747970340926, 1281837505141800961, 1, 1281777434508656641, '郑平', 0);
INSERT INTO `e_r_task` VALUES (1281838075017691137, 0, NULL, 'consultation_deal', '2020-07-11 14:29:47', 4, '/consultation/getConsultationRegisterList', 6959578747970340926, 1281838074212384769, 1, 1281777434508656641, '郑平', 0);
INSERT INTO `e_r_task` VALUES (1281842020033261569, 0, NULL, 'preach_schdule', '2020-07-11 14:45:28', 2, NULL, 6959578747970340926, 1281842006733123585, 0, 2238899772213054183, '王处长', 0);
INSERT INTO `e_r_task` VALUES (1281855286256115714, 0, NULL, 'maintain_school', '2020-07-11 15:38:11', 0, '/sourceSchool/listCompleteRate', 7201704839644991172, NULL, 0, NULL, NULL, 0);
INSERT INTO `e_r_task` VALUES (1281855286587465729, 0, NULL, 'maintain_preach', '2020-07-11 15:38:11', 1, '/preach-plan/pageAllPreachPlanByUserId', 7201704839644991172, NULL, 0, NULL, NULL, 0);
INSERT INTO `e_r_task` VALUES (1281871770600644610, 0, NULL, 'maintain_school', '2020-07-11 16:43:41', 0, '/sourceSchool/listCompleteRate', 4478489728732514178, NULL, 0, 2238899772213054183, '王处长', 0);
INSERT INTO `e_r_task` VALUES (1281871770919411714, 0, NULL, 'maintain_preach', '2020-07-11 16:43:41', 1, '/preach-plan/pageAllPreachPlanByUserId', 4478489728732514178, NULL, 0, 2238899772213054183, '王处长', 0);
INSERT INTO `e_r_task` VALUES (1282937703741558785, 0, NULL, 'maintain_school', '2020-07-14 15:19:19', 0, '/sourceSchool/listCompleteRate', 3798241326724759975, NULL, 0, 2238899772213054183, '王处长', 0);
INSERT INTO `e_r_task` VALUES (1282937703850610690, 0, NULL, 'maintain_preach', '2020-07-14 15:19:19', 1, '/preach-plan/pageAllPreachPlanByUserId', 3798241326724759975, NULL, 0, 2238899772213054183, '王处长', 0);
...
CREATE TABLE `e_r_task_receiver`  (
  ...
  `task_id` bigint(20) NULL DEFAULT NULL COMMENT '招生任务ID',
  `status` tinyint(4) NULL DEFAULT 0 COMMENT '状态（0：未完成，1：完成）',
  `receiver_id` bigint(20) NULL DEFAULT NULL COMMENT '接收人ID',
  `semester_id` bigint(20) NULL DEFAULT NULL COMMENT '学期ID',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `read_status` tinyint(4) NULL DEFAULT 0 COMMENT '查看状态（0：未读，1：已读）',
  PRIMARY KEY (`task_receiver_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '任务接收人表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of e_r_task_receiver
-- ----------------------------
INSERT INTO `e_r_task_receiver` VALUES (1281774216215044097, 1281774214977724417, 0, 2238899772213054183, 6959578747970340926, '2020-07-11 10:16:02', 1);
INSERT INTO `e_r_task_receiver` VALUES (1281774216718360577, 1281774214977724417, 0, 3380979344860270082, 6959578747970340926, '2020-07-11 10:16:02', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281774217217482753, 1281774214977724417, 0, 3745520413114911150, 6959578747970340926, '2020-07-11 10:16:02', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281774217896960002, 1281774215309074434, 0, 2238899772213054183, 6959578747970340926, '2020-07-11 10:16:02', 1);
INSERT INTO `e_r_task_receiver` VALUES (1281774218400276482, 1281774215309074434, 0, 3380979344860270082, 6959578747970340926, '2020-07-11 10:16:03', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281774218903592962, 1281774215309074434, 0, 3745520413114911150, 6959578747970340926, '2020-07-11 10:16:03', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281837506337177602, 1281837505976467458, 1, 2238899772213054183, 6959578747970340926, '2020-07-11 14:27:31', 1);
INSERT INTO `e_r_task_receiver` VALUES (1281838075332263938, 1281838075017691137, 0, 2238899772213054183, 6959578747970340926, '2020-07-11 14:29:47', 1);
INSERT INTO `e_r_task_receiver` VALUES (1281842020368805890, 1281842020033261569, 0, 2238899772213054183, 6959578747970340926, '2020-07-11 14:45:28', 1);
INSERT INTO `e_r_task_receiver` VALUES (1281855288613314562, 1281855286256115714, 0, 2600711978163717663, 7201704839644991172, '2020-07-11 15:38:11', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281855289120825345, 1281855286256115714, 0, 408638764749505114, 7201704839644991172, '2020-07-11 15:38:11', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281855289624141825, 1281855286256115714, 0, -2862947336221274815, 7201704839644991172, '2020-07-11 15:38:11', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281855290295230465, 1281855286587465729, 0, 2600711978163717663, 7201704839644991172, '2020-07-11 15:38:12', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281855290798546945, 1281855286587465729, 0, 408638764749505114, 7201704839644991172, '2020-07-11 15:38:12', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281855291301863426, 1281855286587465729, 0, -2862947336221274815, 7201704839644991172, '2020-07-11 15:38:12', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281871773918339074, 1281871770600644610, 0, 2238899772213054183, 4478489728732514178, '2020-07-11 16:43:42', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281871774388101122, 1281871770600644610, 0, 3380979344860270082, 4478489728732514178, '2020-07-11 16:43:42', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281871774857863170, 1281871770600644610, 0, 3745520413114911150, 4478489728732514178, '2020-07-11 16:43:42', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281871775482814465, 1281871770919411714, 0, 2238899772213054183, 4478489728732514178, '2020-07-11 16:43:42', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281871775952576513, 1281871770919411714, 0, 3380979344860270082, 4478489728732514178, '2020-07-11 16:43:42', 0);
INSERT INTO `e_r_task_receiver` VALUES (1281871776434921473, 1281871770919411714, 0, 3745520413114911150, 4478489728732514178, '2020-07-11 16:43:42', 0);
INSERT INTO `e_r_task_receiver` VALUES (1282721453166338050, 1281855286256115714, 0, 7403171138704984117, 7201704839644991172, '2020-07-14 01:00:01', 0);
INSERT INTO `e_r_task_receiver` VALUES (1282721455506759681, 1281855286587465729, 0, 7403171138704984117, 7201704839644991172, '2020-07-14 01:00:01', 0);
INSERT INTO `e_r_task_receiver` VALUES (1282937705620606978, 1282937703741558785, 0, 2238899772213054183, 3798241326724759975, '2020-07-14 15:19:20', 0);
INSERT INTO `e_r_task_receiver` VALUES (1282937705792573442, 1282937703741558785, 0, 3380979344860270082, 3798241326724759975, '2020-07-14 15:19:20', 0);
INSERT INTO `e_r_task_receiver` VALUES (1282937705968734209, 1282937703741558785, 0, 3745520413114911150, 3798241326724759975, '2020-07-14 15:19:20', 0);
INSERT INTO `e_r_task_receiver` VALUES (1282937706228781058, 1282937703850610690, 0, 2238899772213054183, 3798241326724759975, '2020-07-14 15:19:20', 0);
INSERT INTO `e_r_task_receiver` VALUES (1282937706417524738, 1282937703850610690, 0, 3380979344860270082, 3798241326724759975, '2020-07-14 15:19:20', 0);
INSERT INTO `e_r_task_receiver` VALUES (1282937706602074113, 1282937703850610690, 0, 3745520413114911150, 3798241326724759975, '2020-07-14 15:19:20', 0);
